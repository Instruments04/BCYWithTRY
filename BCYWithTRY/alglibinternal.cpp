...
static double linmin_xtol = static_cast<double>(100 * ae_machineepsilon);
//static double linmin_xtol = static_cast<double>(1)00*ae_machineepsilon;
...
{
    (void)_state;  // Mark _state as unused
    ae_bool result;
...
double logbase2(double x, ae_state *_state)
{
    ...
    result = ae_log(x, _state)/ae_log(static_cast<double>(2), _state);
    return result;
}
     ...
     ae_state *_state)
{
    ...
    {
        x->ptr.p_double[0] = a;
        y->ptr.p_double[0] = static_cast<double>(2) * ae_randomreal(_state) - static_cast<double>(1);
        h = (b-a)/static_cast<double>(n-1);
        for(i=1; i<=n-1; i++)
        {
            if( i!=n-1 )
            {
                x->ptr.p_double[i] = a+(static_cast<double>(i+0.2*(static_cast<double>(2)*ae_randomreal(_state)-static_cast<double>(1)))*h);
            }
            else
            {
                x->ptr.p_double[i] = b;
            }
            y->ptr.p_double[i] = y->ptr.p_double[i-1]+(static_cast<double>(2)*ae_randomreal(_state)-static_cast<double>(1))*(x->ptr.p_double[i]-x->ptr.p_double[i-1]);
        }
    }
    else
    {
     ...
     ae_state *_state)
{
    ...
    if( n>1 )
    {
        ...
        for(i=1; i<=n-1; i++)
        {
            x->ptr.p_double[i] = a+static_cast<double>(i*h);
            y->ptr.p_double[i] = y->ptr.p_double[i-1]+(static_cast<double>(2)*ae_randomreal(_state)-static_cast<double>(1))*(h);
        }
    }
    else
    {
     ...
     ae_state *_state)
{
    ...
    if( n>1 )
    {
        for(i=0; i<=n-1; i++)
        {
            x->ptr.p_double[i] = 0.5*(b+a)+0.5*(b-a)*ae_cos(ae_pi*static_cast<double>(2*i+1)/static_cast<double>(2*n), _state);
            if( i==0 )
            {
                y->ptr.p_double[i] = static_cast<double>(2)*ae_randomreal(_state)-static_cast<double>(1);
            }
            else
            {
                y->ptr.p_double[i] = y->ptr.p_double[i-1]+(static_cast<double>(2)*ae_randomreal(_state)-static_cast<double>(1))*(x->ptr.p_double[i]-x->ptr.p_double[i-1]);
     ...
     ae_state *_state)
{
    ...
    if( n>1 )
    {
        for(i=0; i<=n-1; i++)
        {
            x->ptr.p_double[i] = 0.5*(b+a)+0.5*(b-a)*ae_cos(ae_pi*static_cast<double>(i)/static_cast<double>(n-1), _state);
            if( i==0 )
            {
                y->ptr.p_double[i] = static_cast<double>(2)*ae_randomreal(_state)-static_cast<double>(1);
            }
     ...
     ae_state *_state)
{
    ...
    for(i=1; i<=n-1; i++)
    {
        if( ae_fp_eq((x->ptr.p_double[i]-a)/(b-a)+static_cast<double>(1),(x->ptr.p_double[i-1]-a)/(b-a)+static_cast<double>(1)) )
        {
            result = ae_false;
            return result;
        }
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        x->ptr.p_double[i] = static_cast<double>(0);
    }
}
     ...
     ae_state *_state)
{
     ...
     * Choose new size
     */
    n = ae_maxint(n, ae_round(1.8*static_cast<double>(x->cnt+static_cast<double>(1)), _state), _state);
     ...
     ae_state *_state)
{
    ...
    if( a->rows<n )
    {
        n = ae_maxint(n, ae_round(1.8*static_cast<double>(a->rows+static_cast<double>(1)), _state), _state);
    }
     ...
     ae_state *_state)
{
    ...
    if( a->cols<n )
    {
        n = ae_maxint(n, ae_round(1.8*static_cast<double>(a->cols+static_cast<double>(1)), _state), _state);
    }
...
double safepythag2(double x, double y, ae_state *_state)
{
    ...
    if( ae_fp_eq(z,static_cast<double>(0)) )
    {
        result = w;
    }
    else
    {
        result = w*ae_sqrt(static_cast<double>(1)+ae_sqr(z/w, _state), _state);
    }
    return result;
}
...
double safepythag3(double x, double y, double z, ae_state *_state)
{
    ...
    if( ae_fp_eq(w,static_cast<double>(0)) )
    {
...
ae_int_t saferdiv(double x, double y, double* r, ae_state *_state)
{
    ...
    *r = 0.0;
     ...
     * * X=0 and Y<>0
     */
    if( ae_fp_eq(y,static_cast<double>(0)) )
    {
        result = 1;
        if( ae_fp_eq(x,static_cast<double>(0)) )
        {
            *r = _state->v_nan;
        }
        if( ae_fp_greater(x,static_cast<double>(0)) )
        {
            *r = _state->v_posinf;
        }
        if( ae_fp_less(x,static_cast<double>(0)) )
        {
            *r = _state->v_neginf;
        }
        return result;
     ...
     * make Y>0
     */
    if( ae_fp_less(y,static_cast<double>(0)) )
    {
        x = -x;
        y = -y;
    }
     ...
     *
     */
    if( ae_fp_greater_eq(y,static_cast<double>(1)) )
    {
        *r = x/y;
     ...
     ae_state *_state)
{
    ...
    *k = static_cast<double>(ae_ifloor((*x-a)/(b-a), _state));
    *x = *x-*k*(b-a);
    while(ae_fp_less(*x,a))
    {
        *x = *x+(b-a);
        *k = *k-static_cast<double>(1);
    }
...
double randomnormal(ae_state *_state)
{
    ...
    for(;;)
    {
        u = static_cast<double>(2)*ae_randomreal(_state)-static_cast<double>(1);
        v = static_cast<double>(2)*ae_randomreal(_state)-static_cast<double>(1);
        s = ae_sqr(u, _state)+ae_sqr(v, _state);
        if( ae_fp_greater(s,static_cast<double>(0))&&ae_fp_less(s,static_cast<double>(1)) )
        {
             ...
             */
            s = ae_sqrt(-static_cast<double>(2)*ae_log(s, _state), _state)/ae_sqrt(s, _state);
            result = u*s;
            break;
        }
    }
...
void randomunit(ae_int_t n, /* Real    */ ae_vector* x, ae_state *_state)
{
    ...
    while(ae_fp_less_eq(v,static_cast<double>(0)));
    v = static_cast<double>(1)/ae_sqrt(v, _state);
    for(i=0; i<=n-1; i++)
    {
...
double possign(double x, ae_state *_state)
{
 ...
 (void)_state;
    ...
    if( ae_fp_greater_eq(x,static_cast<double>(0)) )
    {
     ...
     ae_state *_state)
{
 ...
 (void)_state;
    ...
    for(i=0; i<=n-1; i++)
    {
        if( !(v->ptr.p_double[i]==static_cast<double>(0)) )
        {
            result = result+1;
        }
    }
     ...
     ae_state *_state)
{
 ...
 (void)_state;
    ...
    for(i=0; i<=m-1; i++)
    {
        for(j=0; j<=n-1; j++)
        {
            if( !(v->ptr.pp_double[i][j]==static_cast<double>(0)) )
            {
                result = result+1;
            }
        }
...
void nbpoolinit(nbpool* pool, ae_int_t n, ae_state *_state)
{
    ...
    ae_shared_pool_set_seed(
        &pool->sourcepool,
        &pool->seedn,
        static_cast<ae_int_t>(sizeof(pool->seedn)),
        reinterpret_cast<ae_constructor>(_sbooleanarray_init),
        reinterpret_cast<ae_copy_constructor>(_sbooleanarray_init_copy),
        reinterpret_cast<ae_destructor>(_sbooleanarray_destroy),
        _state
    );
    ...
    ae_shared_pool_set_seed(
        &pool->temporarypool,
        &pool->seed0,
        static_cast<ae_int_t>(sizeof(pool->seed0)),
        reinterpret_cast<ae_constructor>(_sbooleanarray_init),
        reinterpret_cast<ae_copy_constructor>(_sbooleanarray_init_copy),
        reinterpret_cast<ae_destructor>(_sbooleanarray_destroy),
        _state
     ...
     ae_state *_state)
{
    ...
    ae_smart_ptr_init(&_tmp, reinterpret_cast<void**>(&tmp), _state, ae_true);
...
void nipoolinit(nipool* pool, ae_int_t n, ae_state *_state)
{
    ...
    ae_shared_pool_set_seed(
        ...
        &pool->seedn,
        static_cast<ae_int_t>(sizeof(pool->seedn)),
        reinterpret_cast<ae_constructor>(_sintegerarray_init),
        reinterpret_cast<ae_copy_constructor>(_sintegerarray_init_copy),
        reinterpret_cast<ae_destructor>(_sintegerarray_destroy),
        _state
    );
...
void nrpoolinit(nrpool* pool, ae_int_t n, ae_state *_state)
{
    ...
    ae_shared_pool_set_seed(
        ...
        &pool->seedn,
        static_cast<ae_int_t>(sizeof(pool->seedn)),
        reinterpret_cast<ae_constructor>(_srealarray_init),
        reinterpret_cast<ae_copy_constructor>(_srealarray_init_copy),
        reinterpret_cast<ae_destructor>(_srealarray_destroy),
        _state
    );
...
double smpactivationlevel(ae_state *_state)
{
    ...
    nn = static_cast<double>(2*matrixtilesizeb(_state));
    result = ae_maxreal(0.95*static_cast<double>(2)*nn*nn*nn, 1.0E7, _state);
    return result;
}
...
double spawnlevel(ae_state *_state)
{
    ...
    nn = static_cast<double>(2*matrixtilesizea(_state));
    result = 0.95*static_cast<double>(2)*nn*nn*nn;
    return result;
}
     ...
     ae_state *_state)
{
 ...
 (void)_state;
    ...
    for(i=i0; i<=i1-1; i++)
    {
        ...
        {
            ae_trace("%14.6e",
                static_cast<double>(a->ptr.p_double[i]));
        }
        if( prectouse==1 )
        {
            ae_trace("%23.15e",
     ...
     ae_state *_state)
{
 ...
 (void)_state;
    ...
    for(j=j0; j<=j1-1; j++)
    {
        ...
        {
            ae_trace("%14.6e",
                static_cast<double>(a->ptr.pp_double[i][j]));
        }
        if( prectouse==1 )
        {
            ae_trace("%23.15e",
...
void savgcounterinit(savgcounter* c, double priorvalue, ae_state *_state)
{
 ...
 (void)_state;
    c->rsum = static_cast<double>(0);
    c->rcnt = static_cast<double>(0);
    c->prior = priorvalue;
}
...
void savgcounterenqueue(savgcounter* c, double v, ae_state *_state)
{
 ...
 (void)_state;
    c->rsum = c->rsum+v;
    c->rcnt = c->rcnt+static_cast<double>(1);
}
...
double savgcounterget(const savgcounter* c, ae_state *_state)
{
 ...
 (void)_state;
    if( ae_fp_eq(c->rcnt,static_cast<double>(0)) )
    {
        result = c->prior;
    }
    else
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(q,static_cast<double>(0))&&ae_fp_less_eq(q,static_cast<double>(1)), "SQuantileCounterGet: incorrect Q", _state);
    if( c->cnt==0 )
    {
        result = c->prior;
        return result;
    ...
    k = ae_round(q*static_cast<double>(c->cnt-1), _state);
    left = 0;
    right = c->cnt-1;
    for(;;)
    {
...
double stimergetms(stimer* t, ae_state *_state)
{
    ...
    result = static_cast<double>(t->ttotal);
    return result;
}
...
{
    apbuffers* p = static_cast<apbuffers*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    apbuffers* dst = static_cast<apbuffers*>(_dst);
    const apbuffers* src = static_cast<const apbuffers*>(_src);
...
void _sboolean_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    sboolean* p = static_cast<sboolean*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
void _sboolean_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    sboolean* dst = static_cast<sboolean*>(_dst);
    const sboolean* src = static_cast<const sboolean*>(_src);
...
{
    sbooleanarray* p = static_cast<sbooleanarray*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    sbooleanarray* dst = static_cast<sbooleanarray*>(_dst);
    const sbooleanarray* src = static_cast<const sbooleanarray*>(_src);
...
void _sinteger_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    sinteger* p = static_cast<sinteger*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
void _sinteger_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    sinteger* dst = static_cast<sinteger*>(_dst);
    const sinteger* src = static_cast<const sinteger*>(_src);
...
{
    sintegerarray* p = static_cast<sintegerarray*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    sintegerarray* dst = static_cast<sintegerarray*>(_dst);
    const sintegerarray* src = static_cast<const sintegerarray*>(_src);
...
void _sreal_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    sreal* dst = static_cast<sreal*>(_dst);
    const sreal* src = static_cast<const sreal*>(_src);
...
{
    srealarray* p = static_cast<srealarray*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    srealarray* dst = static_cast<srealarray*>(_dst);
    const srealarray* src = static_cast<const srealarray*>(_src);
...
void _scomplex_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    scomplex* p = static_cast<scomplex*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
void _scomplex_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    scomplex* dst = static_cast<scomplex*>(_dst);
    const scomplex* src = static_cast<const scomplex*>(_src);
...
{
    scomplexarray* p = static_cast<scomplexarray*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    scomplexarray* dst = static_cast<scomplexarray*>(_dst);
    const scomplexarray* src = static_cast<const scomplexarray*>(_src);
...
{
    nbpool* p = static_cast<nbpool*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
   // nbpool *p = (nbpool*)_p;
   // ae_touch_ptr((void*)p);
...
{
    nbpool* dst = static_cast<nbpool*>(_dst);
    const nbpool* src = static_cast<const nbpool*>(_src);
...
{
    nipool* p = static_cast<nipool*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
    //nipool *p = (nipool*)_p;
    //ae_touch_ptr((void*)p);
    ae_shared_pool_init(&p->sourcepool, _state, make_automatic);
...
{
    nipool* dst = static_cast<nipool*>(_dst);
    const nipool* src = static_cast<const nipool*>(_src);
...
{
    nrpool* p = static_cast<nrpool*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
   // nrpool *p = (nrpool*)_p;
  //  ae_touch_ptr((void*)p);
    ae_shared_pool_init(&p->sourcepool, _state, make_automatic);
...
{
    nrpool* dst = static_cast<nrpool*>(_dst);
    const nrpool* src = static_cast<const nrpool*>(_src);
...
void _savgcounter_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    savgcounter* p = static_cast<savgcounter*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
void _savgcounter_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    savgcounter* dst = static_cast<savgcounter*>(_dst);
    const savgcounter* src = static_cast<const savgcounter*>(_src);
...
{
    squantilecounter* p = static_cast<squantilecounter*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    squantilecounter* dst = static_cast<squantilecounter*>(_dst);
    const squantilecounter* src = static_cast<const squantilecounter*>(_src);
...
void _stimer_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    stimer* p = static_cast<stimer*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
   // stimer *p = (stimer*)_p;
 //   ae_touch_ptr((void*)p);
}
...
void _stimer_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    stimer* dst = static_cast<stimer*>(_dst);
    const stimer* src = static_cast<const stimer*>(_src);
     ...
     ae_state *_state)
{
     ...
     */
    if( k==0||ae_c_eq_d(alpha,static_cast<double>(0)) )
    {
        if( ae_c_neq_d(beta,static_cast<double>(1)) )
        {
            if( ae_c_neq_d(beta,static_cast<double>(0)) )
            {
                for(i=0; i<=m-1; i++)
                {
                    for(j=0; j<=n-1; j++)
     ...
     */
    a0x = static_cast<double>(0);
    a0y = static_cast<double>(0);
    a1x = static_cast<double>(0);
    a1y = static_cast<double>(0);
    b0x = static_cast<double>(0);
    b0y = static_cast<double>(0);
    b1x = static_cast<double>(0);
    b1y = static_cast<double>(0);
    ...
    while(i<m)
    {
        ...
        while(j<n)
        {
            ...
            if( i+2<=m&&j+2<=n )
            {
                ...
                v11.x = v11x;
                v11.y = v11y;
                if( ae_c_eq_d(beta,static_cast<double>(0)) )
                {
     ...
     ae_state *_state)
{
     ...
     * if K=0 or Alpha=0, then C=Beta*C
     */
    if( k==0||ae_fp_eq(alpha,static_cast<double>(0)) )
    {
        if( ae_fp_neq(beta,static_cast<double>(1)) )
        {
            if( ae_fp_neq(beta,static_cast<double>(0)) )
            {
                for(i=0; i<=m-1; i++)
            ...
            else
            {
                for(i=0; i<=m-1; i++)
                {
                    for(j=0; j<=n-1; j++)
                    {
                        c->ptr.pp_double[ic+i][jc+j] = static_cast<double>(0);
                    }
                }
            }
        }
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_neq(alpha,static_cast<double>(0)), "RMatrixGEMMK44V00: internal error (Alpha=0)", _state);
    ...
    while(i<m)
    {
        ...
        while(j<n)
        {
            ...
            if( i+4<=m&&j+4<=n )
            {
                ...
                if( ae_fp_eq(beta,static_cast<double>(0)) )
                {
     ...
     ae_state *_state)
{
    ...
    oldn = x->cnt;
    newn = ae_maxint(newn, ae_round(1.8*static_cast<double>(oldn)+static_cast<double>(1), _state), _state);
    ae_swap_vectors(x, &oldx);
     ...
     ae_state *_state)
{
     ...
     * calculations).
     */
    mx = static_cast<double>(0);
    for(j=1; j<=n; j++)
    {
        mx = ae_maxreal(ae_c_abs(x->ptr.p_complex[j], _state), mx, _state);
    }
    s = static_cast<double>(1);
    if( ae_fp_neq(mx,static_cast<double>(0)) )
    {
        if( ae_fp_less(mx,static_cast<double>(1)) )
        {
            s = ae_sqrt(ae_minrealnumber, _state);
            v = ae_complex_from_d(static_cast<double>(1)/s);
    ...
    alphr = alpha.x;
    alphi = alpha.y;
    if( ae_fp_eq(xnorm,static_cast<double>(0))&&ae_fp_eq(alphi,static_cast<double>(0)) )
    {
        *tau = ae_complex_from_i(0);
    ...
    if( ae_fp_less(alphr,static_cast<double>(0)) )
    {
        beta = -beta;
    }
    tau->x = (beta-alphr)/beta;
    tau->y = -alphi/beta;
    alpha = ae_c_d_div(static_cast<double>(1),ae_c_sub_d(alpha,beta));
    if( n>1 )
    {
     ...
     ae_state *_state)
{
    ...
    if( (ae_c_eq_d(tau,static_cast<double>(0))||n1>n2)||m1>m2 )
    {
        return;
    }
     ...
     ae_state *_state)
{
    ...
    scl = static_cast<double>(0);
    ssq = static_cast<double>(1);
    for(ix=i1; ix<=i2; ix++)
    {
        if( ae_fp_neq(x->ptr.p_double[ix],static_cast<double>(0)) )
        {
            absxi = ae_fabs(x->ptr.p_double[ix], _state);
            if( ae_fp_less(scl,absxi) )
            {
                ssq = static_cast<double>(1)+ssq*ae_sqr(scl/absxi, _state);
                scl = absxi;
            }
            else
            {
     ...
     ae_state *_state)
{
    ...
    for(j=j1; j<=j2; j++)
    {
        work->ptr.p_double[j] = static_cast<double>(0);
    }
    for(i=i1; i<=i2; i++)
    {
     ...
     ae_state *_state)
{
    ...
    if( !trans )
    {
        ...
        if( ae_fp_eq(beta,static_cast<double>(0)) )
        {
            for(i=iy1; i<=iy2; i++)
            {
                y->ptr.p_double[i] = static_cast<double>(0);
            }
        }
        else
        {
     ...
     ae_state *_state)
{
    ...
    work->ptr.p_double[1] = static_cast<double>(0);
    work->ptr.p_double[i] = static_cast<double>(0);
    ...
    if( ae_fp_eq(beta,static_cast<double>(0)) )
    {
        for(i=ci1; i<=ci2; i++)
        {
            for(j=cj1; j<=cj2; j++)
            {
                c->ptr.pp_double[i][j] = static_cast<double>(0);
            }
        }
    }
    else
    ...
    if( isforward )
    {
        if( n1!=n2 )
        {
            ...
            for(j=m1; j<=m2-1; j++)
            {
                ...
                if( ae_fp_neq(ctemp,static_cast<double>(1))||ae_fp_neq(stemp,static_cast<double>(0)) )
                {
                    jp1 = j+1;
     ...
     ae_state *_state)
{
    ...
    *r = 0.0;
    ...
    if( ae_fp_eq(g,static_cast<double>(0)) )
    {
        *cs = static_cast<double>(1);
        *sn = static_cast<double>(0);
        *r = f;
    }
    else
    {
        if( ae_fp_eq(f,static_cast<double>(0)) )
        {
            *cs = static_cast<double>(0);
            *sn = static_cast<double>(1);
            *r = g;
        }
        else
        {
            ...
            {
                *r = ae_fabs(f1, _state)*ae_sqrt(static_cast<double>(1)+ae_sqr(g1/f1, _state), _state);
            }
            else
            {
                *r = ae_fabs(g1, _state)*ae_sqrt(static_cast<double>(1)+ae_sqr(f1/g1, _state), _state);
            }
            *cs = f1/(*r);
            *sn = g1/(*r);
            if( ae_fp_greater(ae_fabs(f, _state),ae_fabs(g, _state))&&ae_fp_less(*cs,static_cast<double>(0)) )
            {
                *cs = -*cs;
                *sn = -*sn;
                *r = -*r;
     ...
     ae_state *_state)
{
    ...
    if( n==1 )
    {
        x->ptr.p_double[0] = static_cast<double>(0);
        return;
    }
    if( buf->ra1.cnt<n )
    {
    ...
    if( ae_fp_eq(buf->ra1.ptr.p_double[0],buf->ra1.ptr.p_double[n-1]) )
    {
        ...
        {
            tmp = static_cast<double>(n-1)/static_cast<double>(2);
        }
        for(i=0; i<=n-1; i++)
        {
    ...
    while(i<=n-1)
    {
        ...
        for(k=i; k<=j-1; k++)
        {
            buf->ra1.ptr.p_double[k] = static_cast<double>(i+j-1)/static_cast<double>(2);
        }
        i = j;
    }
    ...
    if( iscentered )
    {
        voffs = static_cast<double>(n-1)/static_cast<double>(2);
    }
    else
    {
        voffs = 0.0;
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        x->ptr.p_double[buf->ia1.ptr.p_int[i]] = static_cast<double>(i);
    }
}
...
{
    niset* dst = static_cast<niset*>(_dst);
    const niset* src = static_cast<const niset*>(_src);
     ...
     ae_state *_state)
{
    ...
    *s = 0.0;
     ...
     */
    smlnum = ae_minrealnumber/(ae_machineepsilon*static_cast<double>(2));
    bignum = static_cast<double>(1)/smlnum;
    *s = static_cast<double>(1);
    if( !normin )
    {
        ...
        else
        {
            ...
            cnorm->ptr.p_double[n] = static_cast<double>(0);
        }
    }
    ...
    {
        tscal = static_cast<double>(1);
    }
    else
    {
        tscal = static_cast<double>(1)/(smlnum*tmax);
    ...
    if( notran )
    {
        ...
        if( ae_fp_neq(tscal,static_cast<double>(1)) )
        {
            grow = static_cast<double>(0);
        }
        else
        {
            if( nounit )
            {
                 ...
                 */
                grow = static_cast<double>(1)/ae_maxreal(xbnd, smlnum, _state);
                xbnd = grow;
                j = jfirst;
                while((jinc>0&&j<=jlast)||(jinc<0&&j>=jlast))
                {
                    ...
                    xbnd = ae_minreal(xbnd, ae_minreal(static_cast<double>(1), tjj, _state)*grow, _state);
            ...
            else
            {
                 ...
                 */
                grow = ae_minreal(static_cast<double>(1), static_cast<double>(1)/ae_maxreal(xbnd, smlnum, _state), _state);
                j = jfirst;
                while((jinc>0&&j<=jlast)||(jinc<0&&j>=jlast))
                {
                     ...
                     * G(j) = G(j-1)*( 1 + CNORM(j) )
                     */
                    grow = grow*(static_cast<double>(1)/(static_cast<double>(1)+cnorm->ptr.p_double[j]));
                    j = j+jinc;
                }
            }
        }
        ...
        else
        {
            if( nounit )
            {
                ...
                while((jinc>0&&j<=jlast)||(jinc<0&&j>=jlast))
                {
                     ...
                     */
                    xj = static_cast<double>(1)+cnorm->ptr.p_double[j];
    ...
    else
    {
        ...
        if( notran )
        {
            ...
            while((jinc>0&&j<=jlast)||(jinc<0&&j>=jlast))
            {
                ...
                {
                    tjjs = tscal;
                    if( ae_fp_eq(tscal,static_cast<double>(1)) )
                    {
                        flg = 100;
                    }
                }
                if( flg!=100 )
                {
                    ...
                    if( ae_fp_greater(tjj,smlnum) )
                    {
                         ...
                         * abs(A(j,j)) > SMLNUM:
                         */
                        if( ae_fp_less(tjj,static_cast<double>(1)) )
                        {
                    ...
                    {
                        if( ae_fp_greater(tjj,static_cast<double>(0)) )
                        {
                            ...
                            if( ae_fp_greater(xj,tjj*bignum) )
                            {
                                 ...
                                 */
                                rec = tjj*bignum/xj;
                                if( ae_fp_greater(cnorm->ptr.p_double[j],static_cast<double>(1)) )
                                {
                        ...
                        else
                        {
                            ...
                            x->ptr.p_double[j] = static_cast<double>(1);
                            xj = static_cast<double>(1);
                            *s = static_cast<double>(0);
                            xmax = static_cast<double>(0);
                        }
                    }
                }
                 ...
                 */
                if( ae_fp_greater(xj,static_cast<double>(1)) )
                {
                    rec = static_cast<double>(1)/xj;
        ...
        else
        {
            ...
            while((jinc>0&&j<=jlast)||(jinc<0&&j>=jlast))
            {
                ...
                xj = ae_fabs(x->ptr.p_double[j], _state);
                uscal = tscal;
                rec = static_cast<double>(1)/ae_maxreal(xmax, static_cast<double>(1), _state);
                if( ae_fp_greater(cnorm->ptr.p_double[j],(bignum-xj)*rec) )
                {
                    ...
                    tjj = ae_fabs(tjjs, _state);
                    if( ae_fp_greater(tjj,static_cast<double>(1)) )
                    {

                        /*
                         * Divide by A(j,j) when scaling x if A(j,j) > 1.
                         */
                        rec = ae_minreal(static_cast<double>(1), rec*tjj, _state);
                        uscal = uscal/tjjs;
                    }
                    if( ae_fp_less(rec,static_cast<double>(1)) )
                    {
                        ae_v_muld(&x->ptr.p_double[1], 1, ae_v_len(1,n), rec);
                        *s = *s*rec;
                        xmax = xmax*rec;
                ...
                sumj = static_cast<double>(0);
                if( ae_fp_eq(uscal,static_cast<double>(1)) )
                {
     ...
     ae_state *_state)
{
    ...
    result = ae_false;
    if( ae_c_eq_d(alpha,static_cast<double>(0)) )
    {
        return result;
    }
    if( ae_c_neq_d(beta,static_cast<double>(0)) )
     ...
     ae_state *_state)
{
    ...
    *rerr = 0.0;
    ...
    if( ae_fp_eq(mx,static_cast<double>(0)) )
    {
        *r = static_cast<double>(0);
        *rerr = static_cast<double>(0);
        return;
     ...
     ae_state *_state)
{
    ...
    *rerr = 0.0;
    ...
    if( ae_fp_eq(mx,static_cast<double>(0)) )
    {
        r->x = static_cast<double>(0);
        rerrx = static_cast<double>(0);
    }
    else
    {
    ...
    if( ae_fp_eq(mx,static_cast<double>(0)) )
    {
        r->y = static_cast<double>(0);
        rerry = static_cast<double>(0);
    }
    else
    {
     ...
     * total error
     */
    if( ae_fp_eq(rerrx,static_cast<double>(0))&&ae_fp_eq(rerry,static_cast<double>(0)) )
    {
        *rerr = static_cast<double>(0);
    }
    else
    {
        *rerr = ae_maxreal(rerrx, rerry, _state)*ae_sqrt(static_cast<double>(1)+ae_sqr(ae_minreal(rerrx, rerry, _state)/ae_maxreal(rerrx, rerry, _state), _state), _state);
    }
}
     ...
     ae_state *_state)
{
    ...
    *rerr = 0.0;
     ...
     * Prepare
     */
    ln2 = ae_log(static_cast<double>(2), _state);
    *rerr = mx*ae_machineepsilon;
    ...
    s = xblas_xfastpow(static_cast<double>(2), -k, _state);
    ...
    while(ae_fp_greater_eq(s*mx,static_cast<double>(1)))
    {
        s = 0.5*s;
    }
    while(ae_fp_less(s*mx,0.5))
    {
        s = static_cast<double>(2)*s;
    }
    ae_v_muld(&w->ptr.p_double[0], 1, ae_v_len(0,n-1), s);
    s = static_cast<double>(1)/s;
     ...
     */
    k = ae_trunc(ae_log(static_cast<double>(536870912)/static_cast<double>(n), _state)/ln2, _state);
    chunk = xblas_xfastpow(static_cast<double>(2), k, _state);
    if( ae_fp_less(chunk,static_cast<double>(2)) )
    {
        chunk = static_cast<double>(2);
    }
    invchunk = static_cast<double>(1)/chunk;
    ...
    *r = static_cast<double>(0);
    ...
    for(;;)
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            v = w->ptr.p_double[i];
            k = ae_trunc(v, _state);
            if( ae_fp_neq(v,static_cast<double>(k)) )
            {
                allzeros = ae_false;
            }
            w->ptr.p_double[i] = chunk*(v-static_cast<double>(k));
            ks = ks+k;
        }
        *r = *r+s*static_cast<double>(ks);
        if( allzeros||ae_fp_eq(s*static_cast<double>(n)+mx,mx) )
        {
            break;
        }
    }
...
static double xblas_xfastpow(double r, ae_int_t n, ae_state *_state)
{
    ...
    if( n<0 )
    {
        result = xblas_xfastpow(static_cast<double>(1)/r, -n, _state);
    }
    return result;
}
     ...
     ae_state *_state)
{
    ...
    *stp = *stp/s;
    ...
    s = static_cast<double>(1)/ae_sqrt(s, _state);
    ae_v_muld(&d->ptr.p_double[0], 1, ae_v_len(0,n-1), s);
    *stp = *stp/s;
}
     ...
     ae_state *_state)
{
    ...
    if( ae_fp_eq(stpmax,static_cast<double>(0)) )
    {
    ...
    for(;;)
    {
        ...
        if( *stage==2 )
        {
            ...
            *info = 0;
             ...
             */
            if( ae_fp_less(stpmax,linmin_stpmin)&&ae_fp_greater(stpmax,static_cast<double>(0)) )
            {
                *info = 5;
                *stp = stpmax;
                *stage = 0;
            ...
            if( ((((((n<=0||ae_fp_less_eq(*stp,static_cast<double>(0)))||ae_fp_less(linmin_ftol,static_cast<double>(0)))||ae_fp_less(gtol,zero))||ae_fp_less(linmin_xtol,zero))||ae_fp_less(linmin_stpmin,zero))||ae_fp_less(stpmax,linmin_stpmin))||linmin_maxfev<=0 )
            {
                *stage = 0;
                return;
            }
            ...
            state->dginit = v;
            if( ae_fp_greater_eq(state->dginit,static_cast<double>(0)) )
            {
                *stage = 0;
                *stp = static_cast<double>(0);
                return;
            }
            ...
            *nfev = 0;
             ...
             */
            state->stx = static_cast<double>(0);
            state->fx = state->finit;
            state->dgx = state->dginit;
            state->sty = static_cast<double>(0);
...
ae_bool armijoiteration(armijostate* state, ae_state *_state)
{
     ...
     * Routine body
     */
    if( (ae_fp_less_eq(state->stplen,static_cast<double>(0))||ae_fp_less(state->stpmax,static_cast<double>(0)))||state->fmax<2 )
    {
        state->info = 0;
        result = ae_false;
        return result;
     ...
     * Bound StpLen
     */
    if( ae_fp_greater(state->stplen,state->stpmax)&&ae_fp_neq(state->stpmax,static_cast<double>(0)) )
    {
    ...
    if( ae_fp_greater(v,state->stpmax)&&ae_fp_neq(state->stpmax,static_cast<double>(0)) )
    {
        v = state->stpmax;
    }
     ...
     ae_state *_state)
{
    ...
    *info = 0;
     ...
     *     CHECK THE INPUT PARAMETERS FOR ERRORS.
     */
    if( ((*brackt&&(ae_fp_less_eq(*stp,ae_minreal(*stx, *sty, _state))||ae_fp_greater_eq(*stp,ae_maxreal(*stx, *sty, _state))))||ae_fp_greater_eq(*dx*(*stp-(*stx)),static_cast<double>(0)))||ae_fp_less(stmax,stmin) )
    {
        return;
    }
    ...
    if( ae_fp_greater(fp,*fx) )
    {
        *info = 1;
        bound = ae_true;
        theta = static_cast<double>(3)*(*fx-fp)/(*stp-(*stx))+(*dx)+dp;
        ...
        r = p/q;
        stpc = *stx+r*(*stp-(*stx));
        stpq = *stx+*dx/((*fx-fp)/(*stp-(*stx))+(*dx))/static_cast<double>(2)*(*stp-(*stx));
        ...
        {
            stpf = stpc+(stpq-stpc)/static_cast<double>(2);
        }
        *brackt = ae_true;
    }
    else
    {
        if( ae_fp_less(sgnd,static_cast<double>(0)) )
        {
        ...
        else
        {
            if( ae_fp_less(ae_fabs(dp, _state),ae_fabs(*dx, _state)) )
            {
                ...
                *info = 3;
                 ...
                 */
                gamma = s*ae_sqrt(ae_maxreal(static_cast<double>(0), ae_sqr(theta/s, _state)-*dx/s*(dp/s), _state), _state);
                if( ae_fp_greater(*stp,*stx) )
                {
                    gamma = -gamma;
                }
                ...
                q = gamma+(*dx-dp)+gamma;
                r = p/q;
                if( ae_fp_less(r,static_cast<double>(0))&&ae_fp_neq(gamma,static_cast<double>(0)) )
                {
                    stpc = *stp+r*(*stx-(*stp));
                }
                else
            ...
            else
            {
                ...
                *info = 4;
                ...
                if( *brackt )
                {
                    theta = static_cast<double>(3)*(fp-(*fy))/(*sty-(*stp))+(*dy)+dp;
...
void _linminstate_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    linminstate* p = static_cast<linminstate*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
void _linminstate_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    linminstate* dst = static_cast<linminstate*>(_dst);
    const linminstate* src = static_cast<const linminstate*>(_src);
...
{
    armijostate* p = static_cast<armijostate*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    armijostate* dst = static_cast<armijostate*>(_dst);
    const armijostate* src = static_cast<const armijostate*>(_src);
...
double nucosm1(double x, ae_state *_state)
{
    ...
    {
        result = ae_cos(x, _state)-static_cast<double>(1);
        return result;
    }
    xx = x*x;
     ...
     ae_state *_state)
{
     ...
     * Base cases
     */
    ra = static_cast<double>(a);
    rb = static_cast<double>(b);
    if( b==0||a==0 )
    {
        result = 0;
        return result;
    ...
    if( ae_fp_eq(ra*rb,static_cast<double>(a*b)) )
    {
        result = a*b%n;
        return result;
    }
     ...
     ae_state *_state)
{
    ...
    ae_shared_pool_set_seed(
        &plan->bluesteinpool,
        &bluesteinbuf,
        static_cast<ae_int_t>(sizeof(bluesteinbuf)),
        reinterpret_cast<ae_constructor>(_srealarray_init),
        reinterpret_cast<ae_copy_constructor>(_srealarray_init_copy),
        reinterpret_cast<ae_destructor>(_srealarray_destroy),
        _state
...
double ftbasegetflopestimate(ae_int_t n, ae_state *_state)
{
    ...
    result = ftbase_ftbaseinefficiencyfactor*(static_cast<double>(4*n)*ae_log(static_cast<double>(n), _state)/ae_log(static_cast<double>(2), _state)-static_cast<double>(6*n)+static_cast<double>(8));
    return result;
}
     ...
     ae_state *_state)
{
    ...
    ae_smart_ptr_init(&_bufa, reinterpret_cast<void**>(&bufa), _state, ae_true);
    ae_smart_ptr_init(&_bufb, reinterpret_cast<void**>(&bufb), _state, ae_true);
    ae_smart_ptr_init(&_bufc, reinterpret_cast<void**>(&bufc), _state, ae_true);
    ae_smart_ptr_init(&_bufd, reinterpret_cast<void**>(&bufd), _state, ae_true);
     ...
     ae_state *_state)
{
    ...
    for(opidx=0; opidx<=operandscnt-1; opidx++)
    {
        for(i=0; i<=n-1; i++)
        {
            hre = static_cast<double>(0);
            him = static_cast<double>(0);
            for(k=0; k<=n-1; k++)
            {
                re = a->ptr.p_double[offs+opidx*operandsize*2+2*k+0];
                im = a->ptr.p_double[offs+opidx*operandsize*2+2*k+1];
                c = ae_cos(-static_cast<double>(2)*ae_pi*static_cast<double>(k)*static_cast<double>(i)/static_cast<double>(n), _state);
                s = ae_sin(-static_cast<double>(2)*ae_pi*static_cast<double>(k)*static_cast<double>(i)/static_cast<double>(n), _state);
                hre = hre+c*re-s*im;
                him = him+c*im+s*re;
            }
     ...
     ae_state *_state)
{
    ...
    if( n==3 )
    {
        c1 = ae_cos(static_cast<double>(2)*ae_pi/static_cast<double>(3), _state)-static_cast<double>(1);
        c2 = ae_sin(static_cast<double>(2)*ae_pi/static_cast<double>(3), _state);
        for(opidx=0; opidx<=operandscnt-1; opidx++)
        {
            aoffset = offs+opidx*operandsize*2;
            a0x = a->ptr.p_double[aoffset+0];
    ...
    if( n==5 )
    {
        v = static_cast<double>(2)*ae_pi/static_cast<double>(5);
        c1 = (ae_cos(v, _state)+ae_cos(static_cast<double>(2)*v, _state))/static_cast<double>(2)-static_cast<double>(1);
        c2 = (ae_cos(v, _state)-ae_cos(static_cast<double>(2)*v, _state))/static_cast<double>(2);
        c3 = -ae_sin(v, _state);
        c4 = -(ae_sin(v, _state)+ae_sin(static_cast<double>(2)*v, _state));
        c5 = ae_sin(v, _state)-ae_sin(static_cast<double>(2)*v, _state);
        for(opidx=0; opidx<=operandscnt-1; opidx++)
        {
            aoffset = offs+opidx*operandsize*2;
    ...
    if( n==6 )
    {
        c1 = ae_cos(static_cast<double>(2)*ae_pi/static_cast<double>(3), _state)-static_cast<double>(1);
        c2 = ae_sin(static_cast<double>(2)*ae_pi/static_cast<double>(3), _state);
        c3 = ae_cos(-ae_pi/static_cast<double>(3), _state);
        c4 = ae_sin(-ae_pi/static_cast<double>(3), _state);
        for(opidx=0; opidx<=operandscnt-1; opidx++)
        {
            aoffset = offs+opidx*operandsize*2;
            a0x = a->ptr.p_double[aoffset+0];
     ...
     ae_state *_state)
{
    ...
    if( n==2 )
    {
        v = -static_cast<double>(2)*ae_pi/static_cast<double>(n*m);
        tw0 = -static_cast<double>(2)*ae_sqr(ae_sin(0.5*v, _state), _state);
        tw1 = ae_sin(v, _state);
        for(opidx=0; opidx<=operandscnt-1; opidx++)
        {
            ...
            for(mvidx=0; mvidx<=m-1; mvidx++)
            {
                ...
                a->ptr.p_double[aoffset2] = v2*(static_cast<double>(1)+twxm1)-v3*twy;
                a->ptr.p_double[aoffset2+1] = v3*(static_cast<double>(1)+twxm1)+v2*twy;
                aoffset0 = aoffset0+2;
                aoffset2 = aoffset2+2;
                if( (mvidx+1)%ftbase_updatetw==0 )
                {
                    v = -static_cast<double>(2)*ae_pi*static_cast<double>(mvidx+1)/static_cast<double>(n*m);
                    twxm1 = ae_sin(0.5*v, _state);
                    twxm1 = -static_cast<double>(2)*twxm1*twxm1;
                    twy = ae_sin(v, _state);
                }
                else
                {
    ...
    if( n==3 )
    {
        ...
        for(opidx=0; opidx<=operandscnt-1; opidx++)
        {
            ...
            for(mvidx=0; mvidx<=m-1; mvidx++)
            {
                ...
                tw2y = static_cast<double>(2)*twx*twy;
                ...
                if( (mvidx+1)%ftbase_updatetw==0 )
                {
                    ...
                    twxm1 = -static_cast<double>(2)*twxm1*twxm1;
                    twy = ae_sin(v, _state);
                    twx = twxm1+static_cast<double>(1);
                }
                else
                {
                    v = twxm1+tw0+twxm1*tw0-twy*tw1;
    ...
    if( n==6 )
    {
        ...
        for(opidx=0; opidx<=operandscnt-1; opidx++)
        {
            ...
            for(mvidx=0; mvidx<=m-1; mvidx++)
            {
                ...
                tw3y = twx*tw2y+twy*tw2x;
                tw4x = tw2x*tw2x-tw2y*tw2y;
                tw4y = static_cast<double>(2)*tw2x*tw2y;
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=2*m-1; i++)
    {
        precr->ptr.p_double[offs+i] = static_cast<double>(0);
    }
    for(i=0; i<=n-1; i++)
    {
        bx = ae_cos(ae_pi/static_cast<double>(n)*static_cast<double>(i)*static_cast<double>(i), _state);
        by = ae_sin(ae_pi/static_cast<double>(n)*static_cast<double>(i)*static_cast<double>(i), _state);
     ...
     ae_state *_state)
{
    ...
    for(op=0; op<=operandscnt-1; op++)
    {
        ...
        for(i=2*n; i<=2*m-1; i++)
        {
            bufa->ptr.p_double[i] = static_cast<double>(0);
        }
        ...
        for(i=0; i<=n-1; i++)
        {
            ...
            rx = bufa->ptr.p_double[p1+0]/static_cast<double>(m);
            ry = -bufa->ptr.p_double[p1+1]/static_cast<double>(m);
     ...
     ae_state *_state)
{
    ...
    for(q=0; q<=n-2; q++)
    {
        v = -static_cast<double>(2)*ae_pi*static_cast<double>(kiq)/static_cast<double>(n);
     ...
     ae_state *_state)
{
    ...
    for(opidx=0; opidx<=operandscnt-1; opidx++)
    {
        ...
        for(i=0; i<=n-2; i++)
        {
            a->ptr.p_double[p0+0] = a->ptr.p_double[p0+0]/static_cast<double>(n-1);
            a->ptr.p_double[p0+1] = -a->ptr.p_double[p0+1]/static_cast<double>(n-1);
            p0 = p0+2;
        }
     ...
     ae_state *_state)
{
    ...
    *n2 = 0;
    ...
    if( n>ftbase_recursivethreshold )
    {
        k = ae_iceil(ae_sqrt(static_cast<double>(n), _state), _state)+1;
...
static ae_int_t ftbase_ftoptimisticestimate(ae_int_t n, ae_state *_state)
{
    ...
    result = ae_ifloor(1.0E-5*static_cast<double>(5)*static_cast<double>(n)*ae_log(static_cast<double>(n), _state)/ae_log(static_cast<double>(2), _state), _state);
    return result;
}
     ...
     ae_state *_state)
{
    ...
    halfn1 = n1/2;
    n = n1*n2;
    v = -static_cast<double>(2)*ae_pi/static_cast<double>(n);
    twbasexm1 = -static_cast<double>(2)*ae_sqr(ae_sin(0.5*v, _state), _state);
    twbasey = ae_sin(v, _state);
    twrowxm1 = static_cast<double>(0);
    twrowy = static_cast<double>(0);
    offs = aoffset;
    for(i=0; i<=n2-1; i++)
    {
         ...
         */
        twxm1 = static_cast<double>(0);
        twy = static_cast<double>(0);
        ...
        for(j2=0; j2<=halfn1-1; j2++)
        {
            ...
            tmpx = x*(static_cast<double>(1)+twxm1)-y*twy;
            tmpy = x*twy+y*(static_cast<double>(1)+twxm1);
            a->ptr.p_double[offs+0] = tmpx;
            a->ptr.p_double[offs+1] = tmpy;
            tmpx = (static_cast<double>(1)+twxm1)*twrowxm1-twy*twrowy;
            twy = twy+(static_cast<double>(1)+twxm1)*twrowy+twy*twrowxm1;
            twxm1 = twxm1+tmpx;
            ...
            if( (j2+1)%updatetw2==0&&j2<halfn1-1 )
            {
                 ...
                 */
                v = -static_cast<double>(2)*ae_pi*static_cast<double>(i)*static_cast<double>(2)*static_cast<double>(j2+1)/static_cast<double>(n);
                twxm1 = ae_sin(0.5*v, _state);
                twxm1 = -static_cast<double>(2)*twxm1*twxm1;
                twy = ae_sin(v, _state);
            }
        ...
        if( i<n2-1 )
        {
            ...
            {
                v = -static_cast<double>(2)*ae_pi*static_cast<double>(i+1)/static_cast<double>(n);
                twrowxm1 = ae_sin(0.5*v, _state);
                twrowxm1 = -static_cast<double>(2)*twrowxm1*twrowxm1;
...
void _fasttransformplan_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
    ...
    fasttransformplan* p = static_cast<fasttransformplan*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    fasttransformplan* dst = static_cast<fasttransformplan*>(_dst);
    const fasttransformplan* src = static_cast<const fasttransformplan*>(_src);
...
{
    mlpbuffers* p = static_cast<mlpbuffers*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    mlpbuffers* dst = static_cast<mlpbuffers*>(_dst);
    const mlpbuffers* src = static_cast<const mlpbuffers*>(_src);
