...
#define ALGLIB_USE_LINUX_EXTENSIONS
#endif

/* return types for worker functions for different OS types*/
#if AE_OS==AE_WINDOWS
#define ALGLIB_THREAD_RETURN_TYPE  DWORD WINAPI
#define ALGLIB_THREAD_RETURN       return 0
#elif AE_OS==AE_POSIX
#define ALGLIB_THREAD_RETURN_TYPE  void*
#define ALGLIB_THREAD_RETURN       return NULL
#else
#define ALGLIB_THREAD_RETURN_TYPE  void
#define ALGLIB_THREAD_RETURN       return
#endif
...
/* state flags */
#define ALGLIB_FLG_THREADING_MASK_WRK              0x7
#define ALGLIB_FLG_THREADING_MASK_CBK              (0x7<<3)
#define ALGLIB_FLG_THREADING_MASK_ALL              (ALGLIB_FLG_THREADING_MASK_WRK|ALGLIB_FLG_THREADING_MASK_CBK)
#define ALGLIB_FLG_THREADING_SHIFT                 0
#define ALGLIB_FLG_THREADING_USE_GLOBAL            0x0
#define ALGLIB_FLG_THREADING_SERIAL                0x1
#define ALGLIB_FLG_THREADING_PARALLEL              0x2
#define ALGLIB_FLG_THREADING_SERIAL_CALLBACKS      (0x1<<3)
#define ALGLIB_FLG_THREADING_PARALLEL_CALLBACKS    (0x2<<3)
 ...
 * - defines ALGLIB_HAS_SSE2_INTRINSICS, ALGLIB_HAS_AVX2_INTRINSICS and ALGLIB_HAS_FMA_INTRINSICS definitions
 *
 * These actions are performed when we have:
 * - x86 architecture definition (AE_CPU==AE_INTEL)
 * - compiler which supports intrinsics
 *
 * Presence of ALGLIB_HAS_???_INTRINSICS does NOT mean that our CPU
 ...
 */
     ...
     */
         ...
         */
            ...
            #define ALGLIB_HAS_SSE2_INTRINSICS
            #if !defined(AE_NO_AVX2)
                #include <intrin.h>
                #define ALGLIB_HAS_AVX2_INTRINSICS
                #if !defined(AE_NO_FMA)
                    #define ALGLIB_HAS_FMA_INTRINSICS
                #endif
            #endif
        #endif
    #elif AE_COMPILER==AE_GNUC
     ...
     */
    #if defined(ALGLIB_INTEGRITY_CHECKS_ONCE)
        #if defined(ALGLIB_FAIL_WITHOUT_FMA_INTRINSICS) && !defined(ALGLIB_HAS_FMA_INTRINSICS)
...
/************************************************************************
Internal macros, defined only when ALGLIB_IMPL_DEFINES is defined before
inclusion of this header file
************************************************************************/
#if defined(ALGLIB_IMPL_DEFINES)
    #define ALGLIB_SIMD_ALIGNMENT_DOUBLES 8
    #define ALGLIB_SIMD_ALIGNMENT_BYTES   (_ALGLIB_SIMD_ALIGNMENT_DOUBLES*8)
    /*
     * SIMD kernel dispatchers
     */
    #if defined(ALGLIB_HAS_SSE2_INTRINSICS)
        #define ALGLIB_KKK_VOID_SSE2(fname,params)   if( cached_cpuid&CPU_SSE2 ) { fname##_sse2 params; return; }
        #define ALGLIB_KKK_RETURN_SSE2(fname,params) if( cached_cpuid&CPU_SSE2 ) { return fname##_sse2 params; }
    #else
        #define ALGLIB_KKK_VOID_SSE2(fname,params)
        #define ALGLIB_KKK_RETURN_SSE2(fname,params)
    #endif
    #if defined(ALGLIB_HAS_AVX2_INTRINSICS)
        #define ALGLIB_KKK_VOID_AVX2(fname,params)   if( cached_cpuid&CPU_AVX2 ) { fname##_avx2 params; return; }
        #define ALGLIB_KKK_RETURN_AVX2(fname,params) if( cached_cpuid&CPU_AVX2 ) { return fname##_avx2 params; }
    #else
        #define ALGLIB_KKK_VOID_AVX2(fname,params)
        #define ALGLIB_KKK_RETURN_AVX2(fname,params)
    #endif
    #if defined(ALGLIB_HAS_FMA_INTRINSICS)
        #define ALGLIB_KKK_VOID_FMA(fname,params)    if( cached_cpuid&CPU_FMA )  { fname##_fma params; return; }
        #define ALGLIB_KKK_RETURN_FMA(fname,params)  if( cached_cpuid&CPU_FMA )  { return fname##_fma params; }
    #else
        #define ALGLIB_KKK_VOID_FMA(fname,params)
        #define ALGLIB_KKK_RETURN_FMA(fname,params)
    #endif
    
    #if defined(ALGLIB_HAS_SSE2_INTRINSICS) || defined(ALGLIB_HAS_AVX2_INTRINSICS)
        #define ALGLIB_KERNEL_VOID_SSE2_AVX2(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            ALGLIB_KKK_VOID_AVX2(fname,params)\
            ALGLIB_KKK_VOID_SSE2(fname,params)\
        }
        #define ALGLIB_KERNEL_RETURN_SSE2_AVX2(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            ALGLIB_KKK_RETURN_AVX2(fname,params)\
            ALGLIB_KKK_RETURN_SSE2(fname,params)\
        }
    #else
        #define ALGLIB_KERNEL_VOID_SSE2_AVX2(fname,params)   {}
        #define ALGLIB_KERNEL_RETURN_SSE2_AVX2(fname,params) {}
    ...
    #if defined(ALGLIB_HAS_SSE2_INTRINSICS) || defined(ALGLIB_HAS_AVX2_INTRINSICS) || defined(ALGLIB_HAS_FMA_INTRINSICS)
        #define ALGLIB_KERNEL_VOID_SSE2_AVX2_FMA(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            ALGLIB_KKK_VOID_FMA(fname,params)\
            ALGLIB_KKK_VOID_AVX2(fname,params)\
            ALGLIB_KKK_VOID_SSE2(fname,params)\
        }
        #define ALGLIB_KERNEL_RETURN_SSE2_AVX2_FMA(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            ALGLIB_KKK_RETURN_FMA(fname,params)\
            ALGLIB_KKK_RETURN_AVX2(fname,params)\
            ALGLIB_KKK_RETURN_SSE2(fname,params)\
        }
    #else
    ...
    #if defined(ALGLIB_HAS_AVX2_INTRINSICS) || defined(ALGLIB_HAS_FMA_INTRINSICS)
        #define ALGLIB_KERNEL_VOID_AVX2_FMA(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            ALGLIB_KKK_VOID_FMA(fname,params)\
            ALGLIB_KKK_VOID_AVX2(fname,params)\
        }
        #define ALGLIB_KERNEL_RETURN_AVX2_FMA(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            ALGLIB_KKK_RETURN_FMA(fname,params)\
            ALGLIB_KKK_RETURN_AVX2(fname,params)\
    ...
    #if defined(ALGLIB_HAS_AVX2_INTRINSICS)
        #define ALGLIB_KERNEL_VOID_AVX2(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            ALGLIB_KKK_VOID_AVX2(fname,params)\
        }
        #define ALGLIB_KERNEL_RETURN_AVX2(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            ALGLIB_KKK_RETURN_AVX2(fname,params)\
        }
    ...
    #if defined(ALGLIB_HAS_FMA_INTRINSICS)
        #define ALGLIB_KERNEL_VOID_FMA(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            ALGLIB_KKK_VOID_FMA(fname,params)\
        }
        #define ALGLIB_KERNEL_RETURN_FMA(fname,params) \
        {\
            ae_int_t cached_cpuid = ae_cpuid();\
            ALGLIB_KKK_RETURN_FMA(fname,params)\
        }
...
//////////////////////////////
#define ALGLIB_CPP_EXCEPTION(msg) throw alglib::ap_error(msg)
#define ALGLIB_CALLBACK_EXCEPTION_GUARD_BEGIN          try{
#define ALGLIB_CALLBACK_EXCEPTION_GUARD_END            }catch(...){ ae_clean_up_before_breaking(&_alglib_env_state); throw; }
...
#endif
#define ALGLIB_CALLBACK_EXCEPTION_GUARD_BEGIN
#define ALGLIB_CALLBACK_EXCEPTION_GUARD_END
#define ALGLIB_SET_ERROR_FLAG(s) set_error_flag(s)
...
ae_bool _ialglib_i_rmatrixgerf(ae_int_t m,
     ...
     */
    #if !defined(ABLASF_KERNEL_SIZE1)
    #define ABLASF_KERNEL_SIZE1 16
    #endif
    #if !defined(ABLASF_KERNEL_SIZE2)
    #define ABLASF_KERNEL_SIZE2 16
    #endif
    #define ABLASF_BLOCK_SIZE 32
    #define ABLASF_MICRO_SIZE  2
    #if defined(ALGLIB_HAS_AVX2_INTRINSICS) || defined(ALGLIB_HAS_FMA_INTRINSICS)
