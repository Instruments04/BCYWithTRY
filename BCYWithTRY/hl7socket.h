...
struct HL7Socket
{
    HL7Socket(const std::string& host,
              const std::string& port , Ui::MainWindow *ui)
        :ui(ui),_socketfd(-1), data_check_func(false)
    {
        addrinfo hints;
#ifdef WIN32
        WSADATA	wsaData;
