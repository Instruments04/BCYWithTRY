...
void gqgeneraterec(const real_1d_array &alpha, const real_1d_array &beta, const double mu0, const ae_int_t n, ae_int_t &info, real_1d_array &x, real_1d_array &w, const xparams _xparams)
{
    ...
    if (_xparams.flags != static_cast<alglib_impl::ae_uint64_t>(0x0))
        ...
        //if (_xparams.flags != static_cast<alglib_impl::ae_uint64_t>(0x0))//if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
...
_autogkreport_owner::_autogkreport_owner()
{
  ...
  //  p_struct = (alglib_impl::autogkreport*)alglib_impl::ae_malloc(sizeof(alglib_impl::autogkreport), &_state);
    p_struct = reinterpret_cast<alglib_impl::autogkreport*>(alglib_impl::ae_malloc(sizeof(alglib_impl::autogkreport), &_state));
...
_autogkstate_owner::_autogkstate_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = reinterpret_cast<alglib_impl::autogkstate*>(alglib_impl::ae_malloc(sizeof(alglib_impl::autogkstate), &_state));
...
void autogkintegrate(autogkstate &state,
    ...
    if (_xparams.flags != static_cast<alglib_impl::ae_uint64_t>(0x0))//if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
        ae_state_set_flags(&_alglib_env_state, _xparams.flags);
    alglib_impl::ae_assert(func!=nullptr, "ALGLIB: error in 'autogkintegrate()' (func is NULL)", &_alglib_env_state);
     ...
     ae_state *_state)
{
    ...
    *info = 1;
    ...
    for(i=1; i<=n-1; i++)
    {
        ...
        if( ae_fp_less_eq(beta->ptr.p_double[i],static_cast<double>(0)) )
        {
            *info = -2;
            ae_frame_leave(_state);
            return;
     ...
     ae_state *_state)
{
    ...
    *info = 1;
     ...
     */
    beta.ptr.p_double[0] = static_cast<double>(0);
    pim1a = static_cast<double>(0);
    pia = static_cast<double>(1);
    pim1b = static_cast<double>(0);
    pib = static_cast<double>(1);
    ...
    if( ae_fp_less(bet,static_cast<double>((0)) ))
    {
        *info = -3;
        ae_frame_leave(_state);
        return;
     ...
     ae_state *_state)
{
    ...
    *info = 1;
     ...
     */
    beta.ptr.p_double[0] = static_cast<double>(0);
    polim1 = static_cast<double>(0);
    poli = static_cast<double>(1);
    for(i=1; i<=n; i++)
    {
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        alpha.ptr.p_double[i] = static_cast<double>(0);
    }
    beta.ptr.p_double[0] = static_cast<double>(2);
    for(i=1; i<=n-1; i++)
    {
        beta.ptr.p_double[i] = static_cast<double>(1)/(static_cast<double>(4)-static_cast<double>(1)/ae_sqr(static_cast<double>(i), _state));
    }
    ...
    if( *info>0 )
    {
        if( ae_fp_less(x->ptr.p_double[0],static_cast<double>(-1))||ae_fp_greater(x->ptr.p_double[n-1],static_cast<double>(1)) )
        {
            *info = -4;
        }
        for(i=0; i<=n-2; i++)
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    if( (n<1||ae_fp_less_eq(alpha,static_cast<double>(-1)))||ae_fp_less_eq(beta,static_cast<double>(-1)) )
    {
        *info = -1;
        ae_frame_leave(_state);
        return;
    ...
    apb = alpha+beta;
    a.ptr.p_double[0] = (beta-alpha)/(apb+static_cast<double>(2));
    t = (apb+static_cast<double>(1))*ae_log(static_cast<double>(2), _state)+lngamma(alpha+static_cast<double>(1), &s, _state)+lngamma(beta+static_cast<double>(1), &s, _state)-lngamma(apb+static_cast<double>(2), &s, _state);
    ...
    if( n>1 )
    {
        ...
        a.ptr.p_double[1] = (beta2-alpha2)/((apb+static_cast<double>(2))*(apb+static_cast<double>(4)));
        b.ptr.p_double[1] = static_cast<double>(4)*(alpha+static_cast<double>(1))*(beta+static_cast<double>(1))/((apb+static_cast<double>(3))*ae_sqr(apb+static_cast<double>(2), _state));
        for(i=2; i<=n-1; i++)
        {
            a.ptr.p_double[i] = 0.25*(beta2-alpha2)/(static_cast<double>(i*i)*(static_cast<double>(1)+0.5*apb/static_cast<double>(i))*(static_cast<double>(1)+0.5*(apb+static_cast<double>(2))/static_cast<double>(i)));
            b.ptr.p_double[i] = 0.25*(static_cast<double>(1)+alpha/static_cast<double>(i))*(static_cast<double>(1)+beta/static_cast<double>(i))*(static_cast<double>(1)+apb/static_cast<double>(i))/((static_cast<double>(1)+0.5*(apb+static_cast<double>(1))/static_cast<double>(i))*(static_cast<double>(1)+0.5*(apb-static_cast<double>(1))/static_cast<double>(i))*ae_sqr(static_cast<double>(1)+0.5*apb/static_cast<double>(i), _state));
        }
    }
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    if( n<1||ae_fp_less_eq(alpha,static_cast<double>(-1)) )
    {
        *info = -1;
        ae_frame_leave(_state);
        return;
    ...
    ae_vector_set_length(&a, n, _state);
    ae_vector_set_length(&b, n, _state);
    a.ptr.p_double[0] = alpha+static_cast<double>(1);
    t = lngamma(alpha+static_cast<double>(1), &s, _state);
    ...
    if( n>1 )
    {
        for(i=1; i<=n-1; i++)
        {
            a.ptr.p_double[i] = static_cast<double>(2*i)+alpha+static_cast<double>(1);
            b.ptr.p_double[i] = static_cast<double>(i)*(static_cast<double>(i)+alpha);
        }
    }
    gqgeneraterec(&a, &b, b.ptr.p_double[0], n, info, x, w, _state);
    ...
    if( *info>0 )
    {
        if( ae_fp_less(x->ptr.p_double[0],static_cast<double>(0)) )
        {
            *info = -4;
        }
        for(i=0; i<=n-2; i++)
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    for(i=0; i<=n-1; i++)
    {
        a.ptr.p_double[i] = static_cast<double>(0);
    }
    b.ptr.p_double[0] = ae_sqrt(static_cast<double>(4)*ae_atan(static_cast<double>(1), _state), _state);
    if( n>1 )
    {
        for(i=1; i<=n-1; i++)
        {
            b.ptr.p_double[i] = 0.5*static_cast<double>(i);
        }
    }
    gqgeneraterec(&a, &b, b.ptr.p_double[0], n, info, x, w, _state);
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    for(i=0; i<=ae_iceil(static_cast<double>(3*(n/2))/static_cast<double>(2), _state); i++)
    {
        if( ae_fp_less_eq(beta.ptr.p_double[i],static_cast<double>(0)) )
        {
            *info = -2;
    ...
    *info = 1;
     ...
     */
    ae_vector_set_length(&ta, ae_ifloor(static_cast<double>(3*n)/static_cast<double>(2), _state)+1, _state);
    ae_v_move(&ta.ptr.p_double[0], 1, &alpha.ptr.p_double[0], 1, ae_v_len(0,ae_ifloor(static_cast<double>(3*n)/static_cast<double>(2), _state)));
    ae_vector_set_length(&alpha, 2*n+1, _state);
    ae_v_move(&alpha.ptr.p_double[0], 1, &ta.ptr.p_double[0], 1, ae_v_len(0,ae_ifloor(static_cast<double>(3*n)/static_cast<double>(2), _state)));
    for(i=ae_ifloor(static_cast<double>(3*n)/static_cast<double>(2), _state)+1; i<=2*n; i++)
    {
        alpha.ptr.p_double[i] = static_cast<double>(0);
    }
    ae_vector_set_length(&ta, ae_iceil(static_cast<double>(3*n)/static_cast<double>(2), _state)+1, _state);
    ae_v_move(&ta.ptr.p_double[0], 1, &beta.ptr.p_double[0], 1, ae_v_len(0,ae_iceil(static_cast<double>(3*n)/static_cast<double>(2), _state)));
    ae_vector_set_length(&beta, 2*n+1, _state);
    ae_v_move(&beta.ptr.p_double[0], 1, &ta.ptr.p_double[0], 1, ae_v_len(0,ae_iceil(static_cast<double>(3*n)/static_cast<double>(2), _state)));
    for(i=ae_iceil(static_cast<double>(3*n)/static_cast<double>(2), _state)+1; i<=2*n; i++)
    {
        beta.ptr.p_double[i] = static_cast<double>(0);
    }
    ...
    for(i=0; i<=wlen-1; i++)
    {
        t.ptr.p_double[i] = static_cast<double>(0);
        s.ptr.p_double[i] = static_cast<double>(0);
    }
    ...
    for(i=0; i<=2*n; i++)
    {
        wgauss->ptr.p_double[i] = static_cast<double>(0);
    }
    for(i=0; i<=n-1; i++)
    {
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    if( ae_fp_less_eq(alpha,static_cast<double>(-1))||ae_fp_less_eq(beta,static_cast<double>(-1)) )
    {
        *info = -1;
        ae_frame_leave(_state);
        return;
    }
    clen = ae_iceil(static_cast<double>(3*(n/2))/static_cast<double>(2), _state)+1;
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    ...
    mu0 = static_cast<double>(2);
    alen = ae_ifloor(static_cast<double>(3*(n/2))/static_cast<double>(2), _state)+1;
    blen = ae_iceil(static_cast<double>(3*(n/2))/static_cast<double>(2), _state)+1;
    ae_vector_set_length(&alpha, alen, _state);
    ae_vector_set_length(&beta, blen, _state);
    for(k=0; k<=alen-1; k++)
    {
        alpha.ptr.p_double[k] = static_cast<double>(0);
    }
    beta.ptr.p_double[0] = static_cast<double>(2);
    for(k=1; k<=blen-1; k++)
    {
        beta.ptr.p_double[k] = static_cast<double>(1)/(static_cast<double>(4)-static_cast<double>(1)/ae_sqr(static_cast<double>(k), _state));
    }
     ...
     ae_state *_state)
{
    ...
    *eps = 0.0;
    ...
    for(i=0; i<=n-1; i++)
    {
        ...
        wkronrod->ptr.p_double[i] = static_cast<double>(0);
        wgauss->ptr.p_double[i] = static_cast<double>(0);
    }
    *eps = ae_maxreal(ae_machineepsilon, 1.0E-32, _state);
    ...
    for(i=0; i<=n/2; i++)
    {
        wgauss->ptr.p_double[2*i] = static_cast<double>(0);
    }
...
lbl_3:
    ...
    alpha = ae_minreal(alpha, static_cast<double>(0), _state);
    beta = ae_minreal(beta, static_cast<double>(0), _state);
     ...
     */
    autogk_autogkinternalprepare(static_cast<double>(0), ae_pow(0.5*(b-a), static_cast<double>(1)+alpha, _state), eps, state->xwidth, &state->internalstate, _state);
lbl_9:
    if( !autogk_autogkinternaliteration(&state->internalstate, _state) )
    {
        goto lbl_10;
     ...
     */
    x = state->internalstate.x;
    t = ae_pow(x, static_cast<double>(1)/(static_cast<double>(1)+alpha), _state);
    state->x = a+t;
...
lbl_1:
    state->needf = ae_false;
    if( ae_fp_neq(alpha,static_cast<double>(0)) )
    {
        state->internalstate.f = state->f*ae_pow(x, -alpha/(static_cast<double>(1)+alpha), _state)/(static_cast<double>(1)+alpha);
    }
    else
    {
        state->internalstate.f = state->f;
...
lbl_10:
     ...
     */
    autogk_autogkinternalprepare(static_cast<double>(0), ae_pow(0.5*(b-a), static_cast<double>(1)+beta, _state), eps, state->xwidth, &state->internalstate, _state);
lbl_11:
    if( !autogk_autogkinternaliteration(&state->internalstate, _state) )
    {
        goto lbl_12;
     ...
     */
    x = state->internalstate.x;
    t = ae_pow(x, static_cast<double>(1)/(static_cast<double>(1)+beta), _state);
    state->x = b-t;
    if( ae_fp_greater(s,static_cast<double>(0)) )
    {
        state->xminusa = b-t-a;
...
lbl_2:
    ...
    {
        state->internalstate.f = state->f*ae_pow(x, -beta/(static_cast<double>(1)+beta), _state)/(static_cast<double>(1)+beta);
    }
    else
    {
        state->internalstate.f = state->f;
     ...
     ae_state *_state)
{
     ...
     * test parameters
     */
    if( ae_fp_less(state->eps,static_cast<double>(0))||ae_fp_less(state->xwidth,static_cast<double>(0)) )
    {
        state->info = -1;
        state->r = static_cast<double>(0);
        result = ae_false;
    ...
    state->info = 1;
    if( ae_fp_eq(state->eps,static_cast<double>(0)) )
    {
        state->eps = static_cast<double>(100000)*ae_machineepsilon;
    }
     ...
     */
    if( ae_fp_neq(state->xwidth,static_cast<double>(0)) )
    {
        goto lbl_3;
    }
    ...
    intg = static_cast<double>(0);
    intk = static_cast<double>(0);
    inta = static_cast<double>(0);
    i = 0;
lbl_5:
    if( i>state->n-1 )
    {
...
lbl_3:
    ...
    state->heapwidth = 5;
    ae_matrix_set_length(&state->heap, state->heapsize, state->heapwidth, _state);
    state->sumerr = static_cast<double>(0);
    state->sumabs = static_cast<double>(0);
    j = 0;
lbl_8:
    if( j>ns-1 )
    {
    ...
    ta = state->a+static_cast<double>(j)*(state->b-state->a)/static_cast<double>(ns);
    tb = state->a+static_cast<double>(j+1)*(state->b-state->a)/static_cast<double>(ns);
    c1 = 0.5*(tb-ta);
    c2 = 0.5*(tb+ta);
    intg = static_cast<double>(0);
    intk = static_cast<double>(0);
...
void _autogkreport_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    autogkreport* p = reinterpret_cast<autogkreport*>(_p);
...
void _autogkreport_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    autogkreport* dst = reinterpret_cast<autogkreport*>(_dst);
    const autogkreport* src = reinterpret_cast<const autogkreport*>(_src);
...
{
    autogkinternalstate* p = reinterpret_cast<autogkinternalstate*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    autogkinternalstate* dst = reinterpret_cast<autogkinternalstate*>(_dst);
    const autogkinternalstate* src = reinterpret_cast<const autogkinternalstate*>(_src);
...
{
    autogkstate* p = reinterpret_cast<autogkstate*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    autogkstate* dst = reinterpret_cast<autogkstate*>(_dst);
    const autogkstate* src = reinterpret_cast<const autogkstate*>(_src);
