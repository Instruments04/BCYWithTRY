...
_polynomialsolverreport_owner::_polynomialsolverreport_owner()
{
    ...
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::polynomialsolverreport*>(
        alglib_impl::ae_malloc(sizeof(alglib_impl::polynomialsolverreport), &_state));
...
void polynomialsolve(const real_1d_array &a, const ae_int_t n, complex_1d_array &x, polynomialsolverreport &rep, const xparams _xparams)
{
    ...
    {
#if !defined(AE_NO_EXCEPTIONS)
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
#else
        ALGLIB_SET_ERROR_FLAG(_alglib_env_state.error_msg);
        return;
#endif
    }
    ae_state_set_break_jump(&_alglib_env_state, &_break_jump);
    if (_xparams.flags != static_cast<alglib_impl::ae_uint64_t>(0x0))
...
_densesolverreport_owner::_densesolverreport_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::densesolverreport*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::densesolverreport), &_state));
...
_densesolverlsreport_owner::_densesolverlsreport_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::densesolverlsreport*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::densesolverlsreport), &_state));
...
void rmatrixsolve(const real_2d_array &a, const real_1d_array &b, real_1d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    if( (a.rows()!=a.cols()) || (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixsolve': looks like one of arguments has wrong size");
    n = a.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
bool rmatrixsolvefast(const real_2d_array &a, real_1d_array &b, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixsolvefast': looks like one of arguments has wrong size");
    n = a.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
void rmatrixsolvem(const real_2d_array &a, const real_2d_array &b, const bool rfs, real_2d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    if( (a.rows()!=a.cols()) || (a.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixsolvem': looks like one of arguments has wrong size");
    n = a.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
bool rmatrixsolvemfast(const real_2d_array &a, real_2d_array &b, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixsolvemfast': looks like one of arguments has wrong size");
    n = a.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
void rmatrixlusolve(const real_2d_array &lua, const integer_1d_array &p, const real_1d_array &b, real_1d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    if( (lua.rows()!=lua.cols()) || (lua.rows()!=p.length()) || (lua.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixlusolve': looks like one of arguments has wrong size");
    n = lua.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
bool rmatrixlusolvefast(const real_2d_array &lua, const integer_1d_array &p, real_1d_array &b, const xparams _xparams)
{
    ...
    if( (lua.rows()!=lua.cols()) || (lua.rows()!=p.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixlusolvefast': looks like one of arguments has wrong size");
    n = lua.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
void rmatrixlusolvem(const real_2d_array &lua, const integer_1d_array &p, const real_2d_array &b, real_2d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    if( (lua.rows()!=lua.cols()) || (lua.rows()!=p.length()) || (lua.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixlusolvem': looks like one of arguments has wrong size");
    n = lua.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
bool rmatrixlusolvemfast(const real_2d_array &lua, const integer_1d_array &p, real_2d_array &b, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (lua.rows()!=lua.cols()) || (lua.rows()!=p.length()) || (lua.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixlusolvemfast': looks like one of arguments has wrong size");
    n = lua.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
void rmatrixmixedsolve(const real_2d_array &a, const real_2d_array &lua, const integer_1d_array &p, const real_1d_array &b, real_1d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    if( (a.rows()!=a.cols()) || (a.rows()!=lua.rows()) || (a.rows()!=lua.cols()) || (a.rows()!=p.length()) || (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixmixedsolve': looks like one of arguments has wrong size");
    n = a.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
void rmatrixmixedsolvem(const real_2d_array &a, const real_2d_array &lua, const integer_1d_array &p, const real_2d_array &b, real_2d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    if( (a.rows()!=a.cols()) || (a.rows()!=lua.rows()) || (a.rows()!=lua.cols()) || (a.rows()!=p.length()) || (a.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixmixedsolvem': looks like one of arguments has wrong size");
    n = a.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
void cmatrixsolvem(const complex_2d_array &a, const complex_2d_array &b, const bool rfs, complex_2d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'cmatrixsolvem': looks like one of arguments has wrong size");
    n = a.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
bool cmatrixsolvemfast(const complex_2d_array &a, complex_2d_array &b, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'cmatrixsolvemfast': looks like one of arguments has wrong size");
    n = a.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
void cmatrixsolve(const complex_2d_array &a, const complex_1d_array &b, complex_1d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'cmatrixsolve': looks like one of arguments has wrong size");
    n = a.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
bool cmatrixsolvefast(const complex_2d_array &a, complex_1d_array &b, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'cmatrixsolvefast': looks like one of arguments has wrong size");
    n = a.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
void cmatrixlusolvem(const complex_2d_array &lua, const integer_1d_array &p, const complex_2d_array &b, complex_2d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (lua.rows()!=lua.cols()) || (lua.rows()!=p.length()) || (lua.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'cmatrixlusolvem': looks like one of arguments has wrong size");
    n = lua.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
bool cmatrixlusolvemfast(const complex_2d_array &lua, const integer_1d_array &p, complex_2d_array &b, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (lua.rows()!=lua.cols()) || (lua.rows()!=p.length()) || (lua.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'cmatrixlusolvemfast': looks like one of arguments has wrong size");
    n = lua.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
void cmatrixlusolve(const complex_2d_array &lua, const integer_1d_array &p, const complex_1d_array &b, complex_1d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (lua.rows()!=lua.cols()) || (lua.rows()!=p.length()) || (lua.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'cmatrixlusolve': looks like one of arguments has wrong size");
    n = lua.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
bool cmatrixlusolvefast(const complex_2d_array &lua, const integer_1d_array &p, complex_1d_array &b, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (lua.rows()!=lua.cols()) || (lua.rows()!=p.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'cmatrixlusolvefast': looks like one of arguments has wrong size");
    n = lua.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
void cmatrixmixedsolvem(const complex_2d_array &a, const complex_2d_array &lua, const integer_1d_array &p, const complex_2d_array &b, complex_2d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (a.rows()!=a.cols()) || (a.rows()!=lua.rows()) || (a.rows()!=lua.cols()) || (a.rows()!=p.length()) || (a.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'cmatrixmixedsolvem': looks like one of arguments has wrong size");
    n = a.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
void cmatrixmixedsolve(const complex_2d_array &a, const complex_2d_array &lua, const integer_1d_array &p, const complex_1d_array &b, complex_1d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (a.rows()!=a.cols()) || (a.rows()!=lua.rows()) || (a.rows()!=lua.cols()) || (a.rows()!=p.length()) || (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'cmatrixmixedsolve': looks like one of arguments has wrong size");
    n = a.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
void spdmatrixsolvem(const real_2d_array &a, const bool isupper, const real_2d_array &b, real_2d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'spdmatrixsolvem': looks like one of arguments has wrong size");
    n = a.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
bool spdmatrixsolvemfast(const real_2d_array &a, const bool isupper, real_2d_array &b, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'spdmatrixsolvemfast': looks like one of arguments has wrong size");
    n = a.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
void spdmatrixsolve(const real_2d_array &a, const bool isupper, const real_1d_array &b, real_1d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'spdmatrixsolve': looks like one of arguments has wrong size");
    n = a.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
bool spdmatrixsolvefast(const real_2d_array &a, const bool isupper, real_1d_array &b, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'spdmatrixsolvefast': looks like one of arguments has wrong size");
    n = a.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
void spdmatrixcholeskysolvem(const real_2d_array &cha, const bool isupper, const real_2d_array &b, real_2d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    if( (cha.rows()!=cha.cols()) || (cha.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'spdmatrixcholeskysolvem': looks like one of arguments has wrong size");
    n = cha.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
bool spdmatrixcholeskysolvemfast(const real_2d_array &cha, const bool isupper, real_2d_array &b, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (cha.rows()!=cha.cols()) || (cha.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'spdmatrixcholeskysolvemfast': looks like one of arguments has wrong size");
    n = cha.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
void spdmatrixcholeskysolve(const real_2d_array &cha, const bool isupper, const real_1d_array &b, real_1d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    if( (cha.rows()!=cha.cols()) || (cha.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'spdmatrixcholeskysolve': looks like one of arguments has wrong size");
    n = cha.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
bool spdmatrixcholeskysolvefast(const real_2d_array &cha, const bool isupper, real_1d_array &b, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (cha.rows()!=cha.cols()) || (cha.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'spdmatrixcholeskysolvefast': looks like one of arguments has wrong size");
    n = cha.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
void hpdmatrixsolvem(const complex_2d_array &a, const bool isupper, const complex_2d_array &b, complex_2d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'hpdmatrixsolvem': looks like one of arguments has wrong size");
    n = a.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
bool hpdmatrixsolvemfast(const complex_2d_array &a, const bool isupper, complex_2d_array &b, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'hpdmatrixsolvemfast': looks like one of arguments has wrong size");
    n = a.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
void hpdmatrixsolve(const complex_2d_array &a, const bool isupper, const complex_1d_array &b, complex_1d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'hpdmatrixsolve': looks like one of arguments has wrong size");
    n = a.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
bool hpdmatrixsolvefast(const complex_2d_array &a, const bool isupper, complex_1d_array &b, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (a.rows()!=a.cols()) || (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'hpdmatrixsolvefast': looks like one of arguments has wrong size");
    n = a.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
void hpdmatrixcholeskysolvem(const complex_2d_array &cha, const bool isupper, const complex_2d_array &b, complex_2d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (cha.rows()!=cha.cols()) || (cha.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'hpdmatrixcholeskysolvem': looks like one of arguments has wrong size");
    n = cha.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
bool hpdmatrixcholeskysolvemfast(const complex_2d_array &cha, const bool isupper, complex_2d_array &b, const xparams _xparams)
{
    ...
    ae_int_t m;
    if( (cha.rows()!=cha.cols()) || (cha.rows()!=b.rows()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'hpdmatrixcholeskysolvemfast': looks like one of arguments has wrong size");
    n = cha.rows();
    m = b.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
void hpdmatrixcholeskysolve(const complex_2d_array &cha, const bool isupper, const complex_1d_array &b, complex_1d_array &x, densesolverreport &rep, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (cha.rows()!=cha.cols()) || (cha.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'hpdmatrixcholeskysolve': looks like one of arguments has wrong size");
    n = cha.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
bool hpdmatrixcholeskysolvefast(const complex_2d_array &cha, const bool isupper, complex_1d_array &b, const xparams _xparams)
{
    ...
    ae_int_t n;
    if( (cha.rows()!=cha.cols()) || (cha.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'hpdmatrixcholeskysolvefast': looks like one of arguments has wrong size");
    n = cha.rows();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
        ALGLIB_CPP_EXCEPTION(_alglib_env_state.error_msg);
...
void rmatrixsolvels(const real_2d_array &a, const real_1d_array &b, const double threshold, real_1d_array &x, densesolverlsreport &rep, const xparams _xparams)
{
    ...
    ae_int_t ncols;
    if( (a.rows()!=b.length()))
        ALGLIB_CPP_EXCEPTION("Error while calling 'rmatrixsolvels': looks like one of arguments has wrong size");
    nrows = a.rows();
    ncols = a.cols();
    alglib_impl::ae_state_init(&_alglib_env_state);
    if( setjmp(_break_jump) )
...
_sparsesolverreport_owner::_sparsesolverreport_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::sparsesolverreport*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::sparsesolverreport), &_state));
...
_sparsesolverstate_owner::_sparsesolverstate_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::sparsesolverstate*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::sparsesolverstate), &_state));
...
_sparsesolverstate_owner::_sparsesolverstate_owner(const _sparsesolverstate_owner &rhs)
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    alglib_impl::ae_assert(rhs.p_struct!=nullptr, "ALGLIB: sparsesolverstate copy constructor failure (source is not initialized)", &_state);
    p_struct = static_cast<alglib_impl::sparsesolverstate*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::sparsesolverstate), &_state));
//p_struct = (alglib_impl::sparsesolverstate*)alglib_impl::ae_malloc(sizeof(alglib_impl::sparsesolverstate), &_state);
    memset(p_struct, 0, sizeof(alglib_impl::sparsesolverstate));
...
_sparsesolverstate_owner& _sparsesolverstate_owner::operator=(const _sparsesolverstate_owner &rhs)
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    alglib_impl::ae_assert(p_struct!=nullptr, "ALGLIB: sparsesolverstate assignment constructor failure (destination is not initialized)", &_state);
    alglib_impl::ae_assert(rhs.p_struct!=nullptr, "ALGLIB: sparsesolverstate assignment constructor failure (source is not initialized)", &_state);
    alglib_impl::_sparsesolverstate_destroy(p_struct);
    memset(p_struct, 0, sizeof(alglib_impl::sparsesolverstate));
    alglib_impl::_sparsesolverstate_init_copy(p_struct, const_cast<alglib_impl::sparsesolverstate*>(rhs.p_struct), &_state, ae_false);
    ae_state_clear(&_state);
...
_lincgstate_owner::_lincgstate_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::lincgstate*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::lincgstate), &_state));
...
_lincgreport_owner::_lincgreport_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::lincgreport*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::lincgreport), &_state));
...
_linlsqrstate_owner::_linlsqrstate_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::linlsqrstate*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::linlsqrstate), &_state));
...
_linlsqrreport_owner::_linlsqrreport_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::linlsqrreport*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::linlsqrreport), &_state));
...
_nleqstate_owner::_nleqstate_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::nleqstate*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::nleqstate), &_state));
...
_nleqreport_owner::_nleqreport_owner()
{
    ...
    alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
    p_struct = nullptr;
    p_struct = static_cast<alglib_impl::nleqreport*>(
    alglib_impl::ae_malloc(sizeof(alglib_impl::nleqreport), &_state));
...
//if( _xparams.flags!=(alglib_impl::ae_uint64_t)0x0 )
        ae_state_set_flags(&_alglib_env_state, _xparams.flags);
    alglib_impl::ae_assert(func!=nullptr, "ALGLIB: error in 'nleqsolve()' (func is NULL)", &_alglib_env_state);
    alglib_impl::ae_assert(jac!=nullptr,  "ALGLIB: error in 'nleqsolve()' (jac is NULL)", &_alglib_env_state);
    alglib_impl::nleqsetprotocolv1(state.c_ptr(), &_alglib_env_state);
    while( alglib_impl::nleqiteration(state.c_ptr(), &_alglib_env_state) )
    {
        ALGLIB_CALLBACK_EXCEPTION_GUARD_BEGIN
                if( state.needf )
                {
        ...
        ALGLIB_CALLBACK_EXCEPTION_GUARD_END
    lbl_no_callback:
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_neq(a.ptr.p_double[n],static_cast<double>(0)), "PolynomialSolve: A[N]=0", _state);
     ...
     */
    nz = 0;
    while(nz<n&&ae_fp_eq(a.ptr.p_double[nz],static_cast<double>(0)))
    {
        nz = nz+1;
    }
    ne = n-nz;
    ...
    if( ne>0 )
    {
        ...
        for(i=1; i<=ne-1; i++)
        {
            c.ptr.pp_double[i][i-1] = static_cast<double>(1);
     ...
     * Rep
     */
    rep->maxerr = static_cast<double>(0);
    for(i=0; i<=ne-1; i++)
    {
...
void _polynomialsolverreport_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
    ...
    polynomialsolverreport* p = static_cast<polynomialsolverreport*>(_p);
...
void _polynomialsolverreport_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
    (void)make_automatic;
    (void)_state;
    polynomialsolverreport *dst = static_cast<polynomialsolverreport*>(_dst);
    const polynomialsolverreport *src = static_cast<const polynomialsolverreport*>(_src);
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_eq(a.ptr.pp_double[i][i],static_cast<double>(0)) )
        {
            for(j=0; j<=n-1; j++)
            {
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_eq(lua->ptr.pp_double[i][i],static_cast<double>(0)) )
        {
            for(j=0; j<=n-1; j++)
            {
                b->ptr.p_double[j] = 0.0;
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_c_eq_d(a.ptr.pp_complex[i][i],static_cast<double>(0)) )
        {
            for(j=0; j<=n-1; j++)
            {
                for(k=0; k<=m-1; k++)
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n-1; i++)
    {
        if( ae_c_eq_d(lua->ptr.pp_complex[i][i],static_cast<double>(0)) )
        {
            for(j=0; j<=n-1; j++)
            {
                for(k=0; k<=m-1; k++)
     ...
     ae_state *_state)
{
    ...
    if( !spdmatrixcholesky(&da, n, isupper, _state) )
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            for(j=0; j<=m-1; j++)
            {
                x->ptr.pp_double[i][j] = static_cast<double>(0);
            }
        }
        rep->r1 = static_cast<double>(0);
        rep->rinf = static_cast<double>(0);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(threshold, _state)&&ae_fp_greater_eq(threshold,static_cast<double>(0)), "RMatrixSolveLS: Threshold<0 or is infinite", _state);
    ...
    if( ae_fp_eq(threshold,static_cast<double>(0)) )
    {
        threshold = static_cast<double>(1000)*ae_machineepsilon;
    }
    ...
    zeroa = ae_fp_eq(sv.ptr.p_double[0],static_cast<double>(0));
    if( svdfailed||zeroa )
    {
        if( svdfailed )
        {
        ...
        for(i=0; i<=ncols-1; i++)
        {
            for(j=0; j<=ncols-1; j++)
            {
                if( i==j )
                {
                    rep->cx.ptr.pp_double[i][j] = static_cast<double>(1);
                }
                else
                {
                    rep->cx.ptr.pp_double[i][j] = static_cast<double>(0);
                }
            }
        }
        rep->r2 = static_cast<double>(0);
        ae_frame_leave(_state);
        return;
    }
    ...
    for(rfs=0; rfs<=nrfs; rfs++)
    {
        ...
        else
        {
            ...
            for(i=0; i<=nrows-1; i++)
            {
                ...
                ta.ptr.p_double[ncols] = static_cast<double>(-1);
                ...
                rp.ptr.p_double[i] = -v;
                smallerr = smallerr&&ae_fp_less(ae_fabs(v, _state),static_cast<double>(4)*verr);
            }
            if( smallerr )
            {
        ...
        for(i=0; i<=ncols-1; i++)
        {
            tmp.ptr.p_double[i] = static_cast<double>(0);
        }
        for(i=0; i<=nsv-1; i++)
        {
            utb.ptr.p_double[i] = static_cast<double>(0);
        }
        for(i=0; i<=nrows-1; i++)
        {
            v = rp.ptr.p_double[i];
        ...
        for(i=0; i<=nsv-1; i++)
        {
            ...
            {
                sutb.ptr.p_double[i] = static_cast<double>(0);
            }
        }
        for(i=0; i<=nsv-1; i++)
        {
        ...
        for(k=0; k<=m-1; k++)
        {
            ...
            for(rfs=0; rfs<=nrfs-1; rfs++)
            {
                ...
                for(i=0; i<=n-1; i++)
                {
                    ...
                    xa.ptr.p_double[n] = static_cast<double>(-1);
        ...
        if( havea )
        {
            ...
            for(rfs=0; rfs<=nrfs-1; rfs++)
            {
                ...
                for(i=0; i<=n-1; i++)
                {
                    ...
                    smallerr = smallerr&&ae_fp_less(ae_c_abs(v, _state),static_cast<double>(4)*verr);
                }
                if( smallerr )
                {
                    terminatenexttime = ae_true;
     ...
     ae_state *_state)
{
    ...
    result = directdensesolvers_densesolverrfsmax(n, static_cast<double>(0), static_cast<double>(0), _state);
    return result;
}
...
void _densesolverreport_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    densesolverlsreport* p = static_cast<densesolverlsreport*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
void _densesolverreport_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
    ...
    densesolverreport *dst = static_cast<densesolverreport*>(_dst);
    const densesolverreport *src = static_cast<const densesolverreport*>(_src);
...
{
    densesolverlsreport *dst = static_cast<densesolverlsreport*>(_dst);
    const densesolverlsreport *src = static_cast<const densesolverlsreport*>(_src);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(epsf, _state)&&ae_fp_greater_eq(epsf,static_cast<double>(0)), "SparseSolveSymmetricGMRES: EpsF<0 or infinite", _state);
    ae_assert(maxits>=0, "SparseSolveSymmetricGMRES: MaxIts<0", _state);
    if( ae_fp_eq(epsf,static_cast<double>(0))&&maxits==0 )
    {
        epsf = 1.0E-6;
    }
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(epsf, _state)&&ae_fp_greater_eq(epsf,static_cast<double>(0)), "SparseSolveGMRES: EpsF<0 or infinite", _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(epsf, _state)&&ae_fp_greater_eq(epsf,static_cast<double>(0)), "SparseSolverSetCond: EpsF is negative or contains infinite or NaN values", _state);
     ...
     ae_state *_state)
{
    ...
    if( ae_fp_neq(rdotv2(state->n, &state->x0, _state),static_cast<double>(0)) )
    {
        goto lbl_7;
    }
...
lbl_9:
lbl_11:
    if( !(ae_fp_greater(res,static_cast<double>(0))&&(state->maxits==0||state->repiterationscount<state->maxits)) )
    {
        goto lbl_12;
    }
...
lbl_15:
    ...
    if( ae_fp_greater_eq(res,prevres*(static_cast<double>(1)-ae_sqrt(ae_machineepsilon, _state))) )
    {
...
(void)_state;
    ...
    state->repr2 = static_cast<double>(0);
}
...
void _sparsesolverreport_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    sparsesolverreport* p = static_cast<sparsesolverreport*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
void _sparsesolverreport_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
    (void)_state;
    (void)make_automatic;
    sparsesolverreport *dst = static_cast<sparsesolverreport*>(_dst);
    const sparsesolverreport *src = static_cast<const sparsesolverreport*>(_src);
...
{
    sparsesolverstate* p = static_cast<sparsesolverstate*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    sparsesolverstate *dst = static_cast<sparsesolverstate*>(_dst);
    const sparsesolverstate *src = static_cast<const sparsesolverstate*>(_src);
...
void lincgcreate(ae_int_t n, lincgstate* state, ae_state *_state)
{
    ...
    for(i=0; i<=state->n-1; i++)
    {
        ...
        state->b.ptr.p_double[i] = static_cast<double>(0);
    }
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(epsf, _state)&&ae_fp_greater_eq(epsf,static_cast<double>(0)), "LinCGSetCond: EpsF is negative or contains infinite or NaN values", _state);
...
lbl_0:
    ...
    bnorm = static_cast<double>(0);
    state->r2 = static_cast<double>(0);
    state->meritfunction = static_cast<double>(0);
    for(i=0; i<=state->n-1; i++)
    {
        ...
        state->meritfunction = state->meritfunction+state->mv.ptr.p_double[i]*state->rx.ptr.p_double[i]-static_cast<double>(2)*state->b.ptr.p_double[i]*state->rx.ptr.p_double[i];
...
lbl_3:
    state->needvmv = ae_false;
    if( !ae_isfinite(state->vmv, _state)||ae_fp_less_eq(state->vmv,static_cast<double>(0)) )
    {
    ...
    state->alpha = static_cast<double>(0);
    for(i=0; i<=state->n-1; i++)
    {
...
lbl_4:
    ...
    for(i=0; i<=state->n-1; i++)
    {
        v = v+state->mv.ptr.p_double[i]*state->cx.ptr.p_double[i]-static_cast<double>(2)*state->b.ptr.p_double[i]*state->cx.ptr.p_double[i];
    }
...
lbl_7:
    ...
    {
        state->beta = static_cast<double>(0);
        uvar = static_cast<double>(0);
        for(i=0; i<=state->n-1; i++)
        {
         ...
         */
        if( !ae_isfinite(uvar, _state)||ae_fp_eq(uvar,static_cast<double>(0)) )
        {
            state->running = ae_false;
            state->repterminationtype = -4;
            result = ae_false;
     ...
     ae_state *_state)
{
    ...
    if( state->prectype==0 )
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            ...
            if( ae_fp_greater(v,static_cast<double>(0)) )
            {
                state->tmpd.ptr.p_double[i] = static_cast<double>(1)/ae_sqrt(v, _state);
            }
            else
            {
                state->tmpd.ptr.p_double[i] = static_cast<double>(1);
            }
        }
    }
    else
...
{
    lincgstate* p = static_cast<lincgstate*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    lincgstate *dst = static_cast<lincgstate*>(_dst);
    const lincgstate *src = static_cast<const lincgstate*>(_src);
...
void _lincgreport_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    lincgreport* p = static_cast<lincgreport*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
void _lincgreport_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    lincgreport *dst = static_cast<lincgreport*>(_dst);
    const lincgreport *src = static_cast<const lincgreport*>(_src);
     ...
     ae_state *_state)
{
    ...
    state->epsc = static_cast<double>(1)/ae_sqrt(ae_machineepsilon, _state);
    state->maxits = 0;
    state->lambdai = static_cast<double>(0);
    state->xrep = ae_false;
    state->running = ae_false;
    state->repiterationscount = 0;
     ...
     ae_state *_state)
{
    ...
    state->bnorm2 = static_cast<double>(0);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(lambdai, _state)&&ae_fp_greater_eq(lambdai,static_cast<double>(0)), "LinLSQRSetLambdaI: LambdaI is infinite or NaN", _state);
...
lbl_8:
    ...
    for(i=0; i<=state->n-1; i++)
    {
        state->rx.ptr.p_double[i] = static_cast<double>(0);
    }
...
lbl_13:
     ...
     */
    state->betai = bnorm;
    if( ae_fp_eq(state->betai,static_cast<double>(0)) )
    {
    ...
    for(i=0; i<=summn-1; i++)
    {
        ...
        {
            state->ui.ptr.p_double[i] = static_cast<double>(0);
        }
...
lbl_3:
    ...
    for(i=0; i<=state->n-1; i++)
    {
        state->d.ptr.p_double[i] = static_cast<double>(0);
    }
    state->dnorm = static_cast<double>(0);
...
lbl_4:
    ...
    state->betaip1 = static_cast<double>(0);
    for(i=0; i<=summn-1; i++)
    {
    ...
    if( ae_fp_neq(state->betaip1,static_cast<double>(0)) )
    {
...
lbl_5:
    ...
    state->alphaip1 = static_cast<double>(0);
    for(i=0; i<=state->n-1; i++)
    {
    ...
    if( ae_fp_neq(state->alphaip1,static_cast<double>(0)) )
    {
    ...
    for(i=0; i<=state->n-1; i++)
    {
        state->d.ptr.p_double[i] = static_cast<double>(1)/state->rhoi*(state->vi.ptr.p_double[i]-state->theta*state->d.ptr.p_double[i]);
     ...
     ae_state *_state)
{
    ...
    if( state->prectype==0 )
    {
        ...
        for(i=0; i<=n-1; i++)
        {
            state->tmpd.ptr.p_double[i] = static_cast<double>(0);
        }
        t0 = 0;
        t1 = 0;
        ...
        for(i=0; i<=n-1; i++)
        {
            if( ae_fp_greater(state->tmpd.ptr.p_double[i],static_cast<double>(0)) )
            {
                state->tmpd.ptr.p_double[i] = static_cast<double>(1)/ae_sqrt(state->tmpd.ptr.p_double[i], _state);
            }
            else
            {
                state->tmpd.ptr.p_double[i] = static_cast<double>(1);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(epsa, _state)&&ae_fp_greater_eq(epsa,static_cast<double>(0)), "LinLSQRSetCond: EpsA is negative, INF or NAN", _state);
    ae_assert(ae_isfinite(epsb, _state)&&ae_fp_greater_eq(epsb,static_cast<double>(0)), "LinLSQRSetCond: EpsB is negative, INF or NAN", _state);
    ae_assert(maxits>=0, "LinLSQRSetCond: MaxIts is negative", _state);
    if( (ae_fp_eq(epsa,static_cast<double>(0))&&ae_fp_eq(epsb,static_cast<double>(0)))&&maxits==0 )
    {
        state->epsa = linlsqr_atol;
        state->epsb = linlsqr_btol;
...
{
    linlsqrstate* p = static_cast<linlsqrstate*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    linlsqrstate *dst = static_cast<linlsqrstate*>(_dst);
    const linlsqrstate *src = static_cast<const linlsqrstate*>(_src);
...
void _linlsqrreport_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    linlsqrreport* p = static_cast<linlsqrreport*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
void _linlsqrreport_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    linlsqrreport *dst = static_cast<linlsqrreport*>(_dst);
    const linlsqrreport *src = static_cast<const linlsqrreport*>(_src);
     ...
     ae_state *_state)
{
    ...
    if( (solvertype==-19||solvertype==10)||solvertype==11 )
    {
        ...
        reg = ae_sqrt(ae_machineepsilon, _state)*coalesce(v, static_cast<double>(1), _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(reg, _state)&&ae_fp_greater(reg,static_cast<double>(0)), "SparseSolveLS: Reg is not finite or non-positive", _state);
    ...
    if( (solvertype==-19||solvertype==10)||solvertype==11 )
    {
        ...
        normestimatorestimatesparse(&e, &a2, _state);
        normestimatorresults(&e, &v, _state);
        augreg = static_cast<double>(10)*ae_sqrt(ae_machineepsilon, _state)*coalesce(v, static_cast<double>(1), _state);
        directsparsesolvers_sparsesolveaug(&a2, &b2, static_cast<double>(1), ae_maxreal(ae_sqr(augreg, _state), ae_sqr(reg, _state), _state), static_cast<double>(1), ae_sqr(reg, _state), gmresk, maxits, x, rep, _state);
        rmergedivv(n, &sc, x, _state);
        ae_frame_leave(_state);
        return;
    }
     ...
     ae_state *_state)
{
    ...
    m = sparsegetnrows(a, _state);
    n = sparsegetncols(a, _state);
    ae_assert(ae_isfinite(reg1f, _state)&&ae_fp_greater(reg1f,static_cast<double>(0)), "SparseSolveAug: Reg1F is non-positive", _state);
    ae_assert(ae_isfinite(reg2f, _state)&&ae_fp_greater(reg2f,static_cast<double>(0)), "SparseSolveAug: Reg2F is non-positive", _state);
    ae_assert(ae_isfinite(reg1r, _state)&&ae_fp_greater_eq(reg1r,static_cast<double>(0)), "SparseSolveAug: Reg1R is non-positive", _state);
    ae_assert(ae_isfinite(reg2r, _state)&&ae_fp_greater_eq(reg2r,static_cast<double>(0)), "SparseSolveAug: Reg2R is non-positive", _state);
    ...
    sparsesolversetcond(&solver, static_cast<double>(10)*ae_machineepsilon, maxits, _state);
     ...
     ae_state *_state)
{
    ...
    state->n = n;
    state->m = m;
    nleqsetcond(state, static_cast<double>(0), 0, _state);
    nleqsetxrep(state, ae_false, _state);
    nleqsetstpmax(state, static_cast<double>(0), _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(epsf,static_cast<double>(0)), "NLEQSetCond: negative EpsF!", _state);
...
void nleqsetstpmax(nleqstate* state, double stpmax, ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(stpmax,static_cast<double>(0)), "NLEQSetStpMax: StpMax<0!", _state);
    state->stpmax = stpmax;
}
...
lbl_5:
     ...
     * Main cycle
     */
    lambdaup = static_cast<double>(10);
    lambdadown = 0.3;
    lambdav = 0.001;
    rho = static_cast<double>(1);
lbl_7:
    if( ae_false )
    {
        goto lbl_8;
...
lbl_9:
    ...
    for(i=0; i<=n-1; i++)
    {
        state->candstep.ptr.p_double[i] = static_cast<double>(0);
    }
     ...
     */
    stepnorm = static_cast<double>(0);
    for(i=0; i<=n-1; i++)
    {
        if( ae_fp_neq(state->candstep.ptr.p_double[i],static_cast<double>(0)) )
        {
            stepnorm = static_cast<double>(1);
            break;
        }
    }
    linminnormalized(&state->candstep, &stepnorm, n, _state);
    if( ae_fp_neq(state->stpmax,static_cast<double>(0)) )
    {
...
lbl_11:
    ...
    if( ae_fp_eq(stepnorm,static_cast<double>(0))&&state->repterminationtype==0 )
    {
        state->repterminationtype = -4;
    }
    if( state->repiterationscount>=state->maxits&&state->maxits>0 )
     ...
     ae_state *_state)
{
    ...
    if( ae_fp_greater(lnnu+ae_log(static_cast<double>(2), _state),lnmax) )
    {
        return result;
    }
    *lambdav = *lambdav*lambdaup*(*nu);
    *nu = *nu*static_cast<double>(2);
    result = ae_true;
    return result;
}
...
{
    nleqstate* p = static_cast<nleqstate*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
{
    nleqstate *dst = static_cast<nleqstate*>(_dst);
    const nleqstate *src = static_cast<const nleqstate*>(_src);
...
void _nleqreport_init(void* _p, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    nleqreport* p = static_cast<nleqreport*>(_p);
    ae_touch_ptr(static_cast<void*>(p));
...
void _nleqreport_init_copy(void* _dst, const void* _src, ae_state *_state, ae_bool make_automatic)
{
     (void)_state;
     (void)make_automatic;
    nleqreport *dst = static_cast<nleqreport*>(_dst);
    const nleqreport *src = static_cast<const nleqreport*>(_src);
