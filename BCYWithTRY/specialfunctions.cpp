...
double gammafunction(double x, ae_state *_state)
{
    ...
    sgngam = static_cast<double>(1);
    q = ae_fabs(x, _state);
    if( ae_fp_greater(q,33.0) )
    {
        if( ae_fp_less(x,0.0) )
        {
            p = static_cast<double>(ae_ifloor(q, _state));
            i = ae_round(p, _state);
            if( i%2==0 )
            {
                sgngam = static_cast<double>(-1);
    ...
    while(ae_fp_greater_eq(x,static_cast<double>(3)))
    {
        x = x-static_cast<double>(1);
        z = z*x;
    }
    while(ae_fp_less(x,static_cast<double>(0)))
    {
        if( ae_fp_greater(x,-0.000000001) )
        {
            result = z/((static_cast<double>(1)+0.5772156649015329*x)*x);
            return result;
        }
        z = z/x;
        x = x+static_cast<double>(1);
    }
    while(ae_fp_less(x,static_cast<double>(2)))
    {
    ...
    if( ae_fp_eq(x,static_cast<double>(2)) )
    {
        result = z;
        return result;
    }
...
double lngamma(double x, double* sgngam, ae_state *_state)
{
    ...
    *sgngam = static_cast<double>(1);
    ...
    if( ae_fp_less(x,static_cast<double>(13)) )
    {
        z = static_cast<double>(1);
        p = static_cast<double>(0);
        u = x;
        while(ae_fp_greater_eq(u,static_cast<double>(3)))
        {
            p = p-static_cast<double>(1);
            u = x+p;
            z = z*u;
        }
        while(ae_fp_less(u,static_cast<double>(2)))
        {
            z = z/u;
            p = p+static_cast<double>(1);
            u = x+p;
        }
        if( ae_fp_less(z,static_cast<double>(0)) )
        {
            *sgngam = static_cast<double>(-1);
            z = -z;
        }
        ...
        if( ae_fp_eq(u,static_cast<double>(2)) )
        {
            result = ae_log(z, _state);
            return result;
        }
        p = p-static_cast<double>(2);
        x = x+p;
    ...
    if( ae_fp_greater(x,static_cast<double>(100000000)) )
    {
        result = q;
        return result;
    }
    p = static_cast<double>(1)/(x*x);
...
static double gammafunc_gammastirf(double x, ae_state *_state)
{
    ...
    w = static_cast<double>(1)/x;
    stir = 7.87311395793093628397E-4;
    stir = -2.29549961613378126380E-4+w*stir;
    stir = -2.68132617805781232825E-3+w*stir;
    stir = 3.47222221605458667310E-3+w*stir;
    stir = 8.33333333333482257126E-2+w*stir;
    w = static_cast<double>(1)+w*stir;
    y = ae_exp(x, _state);
...
double errorfunction(double x, ae_state *_state)
{
    ...
    s = static_cast<double>(ae_sign(x, _state));
    x = ae_fabs(x, _state);
    if( ae_fp_less(x,0.5) )
    {
        xsq = x*x;
    ...
    if( ae_fp_greater_eq(x,static_cast<double>(10)) )
    {
        result = s;
        return result;
    }
    result = s*(static_cast<double>(1)-errorfunctionc(x, _state));
    return result;
}
...
double errorfunctionc(double x, ae_state *_state)
{
    ...
    {
        result = static_cast<double>(2)-errorfunctionc(-x, _state);
        return result;
    }
    if( ae_fp_less(x,0.5) )
    {
...
double normaldistribution(double x, ae_state *_state)
{
    ...
    result = 0.5*(errorfunction(x/1.41421356237309504880, _state)+static_cast<double>(1));
    return result;
}
...
double normalpdf(double x, ae_state *_state)
{
    ...
    result = ae_exp(-x*x/static_cast<double>(2), _state)/ae_sqrt(static_cast<double>(2)*ae_pi, _state);
    return result;
}
...
double inverf(double e, ae_state *_state)
{
    ...
    result = invnormaldistribution(0.5*(e+static_cast<double>(1)), _state)/ae_sqrt(static_cast<double>(2), _state);
    return result;
}
...
double invnormalcdf(double y0, ae_state *_state)
{
    ...
    if( ae_fp_less_eq(y0,static_cast<double>(0)) )
    {
        result = -ae_maxrealnumber;
        return result;
    }
    if( ae_fp_greater_eq(y0,static_cast<double>(1)) )
    {
        result = ae_maxrealnumber;
        return result;
    }
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_less(static_cast<double>(-1),rho)&&ae_fp_less(rho,static_cast<double>(1)), "BivariateNormalCDF: Rho is not in (-1,+1) range", _state);
    onerho2 = (static_cast<double>(1)-rho)*(static_cast<double>(1)+rho);
    result = ae_exp(-(x*x+y*y-static_cast<double>(2)*rho*x*y)/(static_cast<double>(2)*onerho2), _state)/(static_cast<double>(2)*ae_pi*ae_sqrt(onerho2, _state));
    return result;
}
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_isfinite(rho, _state), "BivariateNormalCDF: Rho is infinite", _state);
    ae_assert(ae_fp_less(static_cast<double>(-1),rho)&&ae_fp_less(rho,static_cast<double>(1)), "BivariateNormalCDF: Rho is not in (-1,+1) range", _state);
    if( ae_fp_eq(rho,static_cast<double>(0)) )
    {
    ...
    if( ae_fp_less_eq(ae_fabs(rho, _state),0.8) )
    {
        ...
        v = v+normaldistr_bvnintegrate3(rangea, rangeb, x, y, 0.0471753363865118, 0.9815606342467192, _state);
        v = v*0.5*(rangeb-rangea)/(static_cast<double>(2)*ae_pi);
    ...
    else
    {
        ...
        x = -x;
        y = -y;
        s = static_cast<double>(ae_sign(rho, _state));
        if( ae_fp_greater(s,static_cast<double>(0)) )
        {
        ...
        rangea = static_cast<double>(0);
        rangeb = ae_sqrt((static_cast<double>(1)-rho)*(static_cast<double>(1)+rho), _state);
        ...
        tc = (static_cast<double>(4)-s*x*y)/static_cast<double>(8);
        v0 = ta*(static_cast<double>(1)-tc*(tb*tb-ta*ta)/static_cast<double>(3))*ae_exp(-tb*tb/(static_cast<double>(2)*ta*ta), _state)-tb*(static_cast<double>(1)-tc*tb*tb/static_cast<double>(3))*ae_sqrt(static_cast<double>(2)*ae_pi, _state)*normalcdf(-tb/ta, _state);
        v0 = v0*ae_exp(-s*x*y/static_cast<double>(2), _state)/(static_cast<double>(2)*ae_pi);

        /*
         * Compute second term (numerical integral, 20-point Gauss-Legendre rule) from formula (6)
         */
        v1 = static_cast<double>(0);
        ...
        v1 = v1+normaldistr_bvnintegrate6(rangea, rangeb, x, y, s, 0.0176140071391521, 0.9931285991850949, _state);
        v1 = v1*0.5*(rangeb-rangea)/(static_cast<double>(2)*ae_pi);
        result = fxys-s*(v0+v1);
    }
    result = ae_maxreal(result, static_cast<double>(0), _state);
    result = ae_minreal(result, static_cast<double>(1), _state);
    return result;
}
     ...
     ae_state *_state)
{
    ...
    dd = static_cast<double>(1)/(static_cast<double>(1)+t2*t2);
    sinr = static_cast<double>(2)*t2*dd;
    cosr = (static_cast<double>(1)-t2*t2)*dd;
    result = gw*ae_exp(-(x*x+y*y-static_cast<double>(2)*x*y*sinr)/(static_cast<double>(2)*cosr*cosr), _state);
    return result;
}
     ...
     ae_state *_state)
{
    ...
    r = (rangeb-rangea)*0.5*gx+(rangeb+rangea)*0.5;
    exphsk22x2 = ae_exp(-(x-s*y)*(x-s*y)/(static_cast<double>(2)*r*r), _state);
    exphsk2 = ae_exp(-x*s*y/static_cast<double>(2), _state);
    sqrt1x2 = ae_sqrt((static_cast<double>(1)-r)*(static_cast<double>(1)+r), _state);
    exphsk1sqrt1x2 = ae_exp(-x*s*y/(static_cast<double>(1)+sqrt1x2), _state);
    result = gw*exphsk22x2*(exphsk1sqrt1x2/sqrt1x2-exphsk2*(static_cast<double>(1)+(static_cast<double>(4)-x*y*s)*r*r/static_cast<double>(8)));
    return result;
}
...
double incompletebeta(double a, double b, double x, ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater(a,static_cast<double>(0))&&ae_fp_greater(b,static_cast<double>(0)), "Domain error in IncompleteBeta", _state);
    ae_assert(ae_fp_greater_eq(x,static_cast<double>(0))&&ae_fp_less_eq(x,static_cast<double>(1)), "Domain error in IncompleteBeta", _state);
    if( ae_fp_eq(x,static_cast<double>(0)) )
    {
        result = static_cast<double>(0);
        return result;
    }
    if( ae_fp_eq(x,static_cast<double>(1)) )
    {
...
double invincompletebeta(double a, double b, double y, ae_state *_state)
{
    ...
    i = 0;
    ae_assert(ae_fp_greater_eq(y,static_cast<double>(0))&&ae_fp_less_eq(y,static_cast<double>(1)), "Domain error in InvIncompleteBeta", _state);
     ...
     */
    dithresh = static_cast<double>(0);
    rflg = 0;
    aaa = static_cast<double>(0);
    bbb = static_cast<double>(0);
    y0 = static_cast<double>(0);
    x = static_cast<double>(0);
    yyy = static_cast<double>(0);
    lgm = static_cast<double>(0);
    dir = 0;
    di = static_cast<double>(0);
     ...
     ae_state *_state)
{
    ...
    do
    {
        ...
        qkm2 = qkm1;
        qkm1 = qk;
        if( ae_fp_neq(qk,static_cast<double>(0)) )
        {
            r = pk/qk;
        }
        if( ae_fp_neq(r,static_cast<double>(0)) )
        {
...
double studenttdistribution(ae_int_t k, double t, ae_state *_state)
{
    ...
    if( ae_fp_eq(t,static_cast<double>(0)) )
    {
        result = 0.5;
        return result;
    }
    ...
    if( ae_fp_less(t,static_cast<double>(0)) )
    {
        x = -t;
    }
    else
    ...
    if( k%2!=0 )
    {
        ...
        if( k>1 )
        {
            ...
            {
                tz = tz*(static_cast<double>(j-1)/(z*static_cast<double>(j)));
                f = f+tz;
                j = j+2;
            }
            p = p+f*xsqk/z;
...
double invstudenttdistribution(ae_int_t k, double p, ae_state *_state)
{
    ...
    ae_assert((k>0&&ae_fp_greater(p,static_cast<double>(0)))&&ae_fp_less(p,static_cast<double>(1)), "Domain error in InvStudentTDistribution", _state);
    rk = static_cast<double>(k);
    ...
    {
        result = static_cast<double>(rflg)*ae_maxrealnumber;
        return result;
    }
    t = ae_sqrt(rk/z-rk, _state);
    result = static_cast<double>(rflg)*t;
    return result;
}
...
double fdistribution(ae_int_t a, ae_int_t b, double x, ae_state *_state)
{
    ...
    ae_assert((a>=1&&b>=1)&&ae_fp_greater_eq(x,static_cast<double>(0)), "Domain error in FDistribution", _state);
    w = static_cast<double>(a)*x;
    w = w/(static_cast<double>(a)+w);
    result = incompletebeta(0.5*static_cast<double>(a), 0.5*static_cast<double>(a), w, _state);
    return result;
}
...
double fcdistribution(ae_int_t a, ae_int_t b, double x, ae_state *_state)
{
    ...
    ae_assert((a>=1&&b>=1)&&ae_fp_greater_eq(x,static_cast<double>(0)), "Domain error in FCDistribution", _state);
    w = static_cast<double>(a)/(static_cast<double>(a)+static_cast<double>(a)*x);
    result = incompletebeta(0.5*static_cast<double>(a), 0.5*static_cast<double>(a), w, _state);
    return result;
}
     ...
     ae_state *_state)
{
    ...
    ae_assert(((a>=1&&b>=1)&&ae_fp_greater(y,static_cast<double>(0)))&&ae_fp_less_eq(y,static_cast<double>(1)), "Domain error in InvFDistribution", _state);

    /*
     * Compute probability for x = 0.5
     */
    w = incompletebeta(0.5*static_cast<double>(a), 0.5*static_cast<double>(a), 0.5, _state);
    ...
    {
        w = invincompletebeta(0.5*static_cast<double>(a), 0.5*static_cast<double>(a), y, _state);
        result = (static_cast<double>(a)-static_cast<double>(a)*w)/(static_cast<double>(a)*w);
    }
    else
    {
        w = invincompletebeta(0.5*static_cast<double>(a), 0.5*static_cast<double>(a), 1.0-y, _state);
        result = static_cast<double>(a)*w/(static_cast<double>(a)*(1.0-w));
    }
    return result;
}
...
double incompletegamma(double a, double x, ae_state *_state)
{
    ...
    if( ae_fp_less_eq(x,static_cast<double>(0))||ae_fp_less_eq(a,static_cast<double>(0)) )
    {
        result = static_cast<double>(0);
        return result;
    }
    if( ae_fp_greater(x,static_cast<double>(1))&&ae_fp_greater(x,a) )
    {
        result = static_cast<double>(1)-incompletegammac(a, x, _state);
        return result;
    }
    ...
    r = a;
    c = static_cast<double>(1);
    ans = static_cast<double>(1);
    do
    {
        r = r+static_cast<double>(1);
        c = c*x/r;
        ans = ans+c;
    }
...
double incompletegammac(double a, double x, ae_state *_state)
{
    ...
    if( ae_fp_less(x,static_cast<double>(1))||ae_fp_less(x,a) )
    {
        result = static_cast<double>(1)-incompletegamma(a, x, _state);
        return result;
    }
    ax = a*ae_log(x, _state)-x-lngamma(a, &tmp, _state);
    if( ae_fp_less(ax,-709.78271289338399) )
    ...
    ax = ae_exp(ax, _state);
    y = static_cast<double>(1)-a;
    z = x+y+static_cast<double>(1);
    c = static_cast<double>(0);
    pkm2 = static_cast<double>(1);
    qkm2 = x;
    pkm1 = x+static_cast<double>(1);
    qkm1 = z*x;
    ans = pkm1/qkm1;
    do
    {
        c = c+static_cast<double>(1);
        y = y+static_cast<double>(1);
        z = z+static_cast<double>(2);
        yc = y*c;
        pk = pkm1*z-pkm2*yc;
        qk = qkm1*z-qkm2*yc;
        if( ae_fp_neq(qk,static_cast<double>(0)) )
...
double invincompletegammac(double a, double y0, ae_state *_state)
{
    ...
    yl = static_cast<double>(0);
    x1 = static_cast<double>(0);
    yh = static_cast<double>(1);
    dithresh = static_cast<double>(5)*igammaepsilon;
    d = static_cast<double>(1)/(static_cast<double>(9)*a);
    y = static_cast<double>(1)-d-invnormaldistribution(y0, _state)*ae_sqrt(d, _state);
    x = a*y*y*y;
    ...
    while(i<10)
    {
        ...
        d = (a-static_cast<double>(1))*ae_log(x, _state)-x-lgm;
    ...
    {
        if( ae_fp_less_eq(x,static_cast<double>(0)) )
        {
            x = static_cast<double>(1);
        }
        while(ae_fp_eq(x0,iinvgammabignumber))
        {
            x = (static_cast<double>(1)+d)*x;
            y = incompletegammac(a, x, _state);
            if( ae_fp_less(y,y0) )
            {
                x0 = x;
...
double chisquaredistribution(double v, double x, ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(x,static_cast<double>(0))&&ae_fp_greater_eq(v,static_cast<double>(1)), "Domain error in ChiSquareDistribution", _state);
...
double chisquarecdistribution(double v, double x, ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(x,static_cast<double>(0))&&ae_fp_greater_eq(v,static_cast<double>(1)), "Domain error in ChiSquareDistributionC", _state);
...
double invchisquaredistribution(double v, double y, ae_state *_state)
{
    ...
    ae_assert((ae_fp_greater_eq(y,static_cast<double>(0))&&ae_fp_less_eq(y,static_cast<double>(1)))&&ae_fp_greater_eq(v,static_cast<double>(1)), "Domain error in InvChiSquareDistribution", _state);
    result = static_cast<double>(2)*invincompletegammac(0.5*v, y, _state);
    return result;
}
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(p,static_cast<double>(0))&&ae_fp_less_eq(p,static_cast<double>(1)), "Domain error in BinomialDistribution", _state);
     ...
     ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(p,static_cast<double>(0))&&ae_fp_less_eq(p,static_cast<double>(1)), "Domain error in BinomialDistributionC", _state);
...
double exponentialintegralei(double x, ae_state *_state)
{
    ...
    if( ae_fp_less(x,static_cast<double>(2)) )
    {
    ...
    if( ae_fp_less(x,static_cast<double>(4)) )
    {
        w = static_cast<double>(1)/x;
        ...
        f = f1/f2;
        result = ae_exp(x, _state)*w*(static_cast<double>(1)+w*f);
        return result;
    }
    if( ae_fp_less(x,static_cast<double>(8)) )
    {
        w = static_cast<double>(1)/x;
    ...
    if( ae_fp_less(x,static_cast<double>(16)) )
    {
        w = static_cast<double>(1)/x;
    ...
    if( ae_fp_less(x,static_cast<double>(32)) )
    {
        w = static_cast<double>(1)/x;
    ...
    if( ae_fp_less(x,static_cast<double>(64)) )
    {
        w = static_cast<double>(1)/x;
...
double exponentialintegralen(double x, ae_int_t n, ae_state *_state)
{
    ...
    big = 1.44115188075855872*ae_pow(static_cast<double>(10), static_cast<double>(17), _state);
    if( ((n<0||ae_fp_less(x,static_cast<double>(0)))||ae_fp_greater(x,static_cast<double>(170)))||(ae_fp_eq(x,static_cast<double>(0))&&n<2) )
    {
        result = static_cast<double>(-1);
        return result;
    }
    if( ae_fp_eq(x,static_cast<double>(0)) )
    {
        result = static_cast<double>(1)/static_cast<double>(n-1);
        return result;
    }
    if( n==0 )
    {
    ...
    if( n>5000 )
    {
        xk = x+static_cast<double>(n);
        yk = static_cast<double>(1)/(xk*xk);
        t = static_cast<double>(n);
        result = yk*t*(static_cast<double>(6)*x*x-static_cast<double>(8)*t*x+t*t);
        result = yk*(result+t*(t-2.0*x));
        result = yk*(result+t);
        result = (result+static_cast<double>(1))*ae_exp(-x, _state)/xk;
        return result;
    }
    if( ae_fp_less_eq(x,static_cast<double>(1)) )
    {
        psi = -eul-ae_log(x, _state);
        for(i=1; i<=n-1; i++)
        {
            psi = psi+static_cast<double>(1)/static_cast<double>(i);
        }
        z = -x;
        xk = static_cast<double>(0);
        yk = static_cast<double>(1);
        pk = static_cast<double>(1-n);
        if( n==1 )
        {
            result = 0.0;
        }
        ...
        do
        {
            xk = xk+static_cast<double>(1);
            yk = yk*z/xk;
            pk = pk+static_cast<double>(1);
            if( ae_fp_neq(pk,static_cast<double>(0)) )
            {
                result = result+yk/pk;
            }
            if( ae_fp_neq(result,static_cast<double>(0)) )
            {
    ...
    else
    {
        ...
        do
        {
            ...
            {
                yk = static_cast<double>(1);
                xk = static_cast<double>(n)+static_cast<double>(k-1)/static_cast<double>(2);
            }
            else
            {
                yk = x;
                xk = static_cast<double>(k)/static_cast<double>(2);
            }
            pk = pkm1*yk+pkm2*xk;
            qk = qkm1*yk+qkm2*xk;
            if( ae_fp_neq(qk,static_cast<double>(0)) )
     ...
     ae_state *_state)
{
    ...
    *ph = 0.0;
    ...
    ae_assert(ae_fp_greater_eq(m,static_cast<double>(0))&&ae_fp_less_eq(m,static_cast<double>(1)), "Domain error in JacobianEllipticFunctions: m<0 or m>1", _state);
     ...
     ae_state *_state)
{
    ...
    *ci = 0.0;
    ...
    if( ae_fp_less_eq(x,static_cast<double>(4)) )
    {
        z = x*x;
     ...
     ae_state *_state)
{
    ...
    for(i=2; i<=n; i++)
    {
        result = static_cast<double>(2)*x*b-a;
        a = b;
        b = result;
    }
    return result;
     ...
     ae_state *_state)
{
    ...
    b1 = static_cast<double>(0);
    b2 = static_cast<double>(0);
    for(i=n; i>=1; i--)
    {
        result = static_cast<double>(2)*x*b1-b2+c->ptr.p_double[i];
        b2 = b1;
        b1 = result;
    }
    if( r==1 )
    ...
    {
        result = -b2+static_cast<double>(2)*x*b1+c->ptr.p_double[0];
    }
    return result;
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n; i++)
    {
        c->ptr.p_double[i] = static_cast<double>(0);
    }
    if( n==0||n==1 )
    {
        c->ptr.p_double[n] = static_cast<double>(1);
    }
    else
    {
        c->ptr.p_double[n] = ae_exp(static_cast<double>(n-1)*ae_log(static_cast<double>(2), _state), _state);
        for(i=0; i<=n/2-1; i++)
        {
            c->ptr.p_double[n-2*(i+1)] = -c->ptr.p_double[n-2*i]*static_cast<double>(n-2*i)*static_cast<double>(n-2*i-1)/static_cast<double>(4)/static_cast<double>(i+1)/static_cast<double>(n-i-1);
        }
    }
}
     ...
     ae_state *_state)
{
    ...
    for(i=0; i<=n; i++)
    {
        b->ptr.p_double[i] = static_cast<double>(0);
    }
    d = static_cast<double>(0);
    i = 0;
    do
    {
        k = i;
        ...
        {
            e = b->ptr.p_double[k];
            b->ptr.p_double[k] = static_cast<double>(0);
            if( i<=1&&k==i )
            {
                b->ptr.p_double[k] = static_cast<double>(1);
            }
            else
            {
                if( i!=0 )
                {
                    b->ptr.p_double[k] = static_cast<double>(2)*d;
                }
                if( k>i+1 )
                {
...
double poissondistribution(ae_int_t k, double m, ae_state *_state)
{
    ...
    ae_assert(k>=0&&ae_fp_greater(m,static_cast<double>(0)), "Domain error in PoissonDistribution", _state);
    result = incompletegammac(static_cast<double>(k+1), m, _state);
    return result;
}
...
double poissoncdistribution(ae_int_t k, double m, ae_state *_state)
{
    ...
    ae_assert(k>=0&&ae_fp_greater(m,static_cast<double>(0)), "Domain error in PoissonDistributionC", _state);
    result = incompletegamma(static_cast<double>(k+1), m, _state);
    return result;
}
...
double invpoissondistribution(ae_int_t k, double y, ae_state *_state)
{
    ...
    ae_assert((k>=0&&ae_fp_greater_eq(y,static_cast<double>(0)))&&ae_fp_less(y,static_cast<double>(1)), "Domain error in InvPoissonDistribution", _state);
    result = invincompletegammac(static_cast<double>(k+1), y, _state);
    return result;
}
...
double beta(double a, double b, ae_state *_state)
{
    ...
    sg = static_cast<double>(1);
    ae_assert(ae_fp_greater(a,static_cast<double>(0))||ae_fp_neq(a,static_cast<double>(ae_ifloor(a, _state))), "Overflow in Beta", _state);
    ae_assert(ae_fp_greater(b,static_cast<double>(0))||ae_fp_neq(b,static_cast<double>(ae_ifloor(b, _state))), "Overflow in Beta", _state);
    y = a+b;
    ...
    ae_assert(ae_fp_neq(y,static_cast<double>(0)), "Overflow in Beta", _state);
...
void fresnelintegral(double x, double* c, double* s, ae_state *_state)
{
    ...
    if( ae_fp_less(x2,2.5625) )
    {
        ...
        *s = static_cast<double>(ae_sign(xxa, _state)*x*x2*sn/sd);
        *c = static_cast<double>(ae_sign(xxa, _state)*x*cn/cd);
        return;
    }
    if( ae_fp_greater(x,36974.0) )
    {
        *c = static_cast<double>(ae_sign(xxa, _state)*0.5);
        *s = static_cast<double>(ae_sign(xxa, _state)*0.5);
        return;
    }
    x2 = x*x;
    t = mpi*x2;
    u = static_cast<double>(1)/(t*t);
    t = static_cast<double>(1)/t;
    ...
    f = static_cast<double>(1)-u*fn/fd;
    g = t*gn/gd;
    t = mpio2*x2;
    cc = ae_cos(t, _state);
    ss = ae_sin(t, _state);
    ...
    *c = 0.5+(f*ss-g*cc)/t;
    *s = 0.5-(f*cc+g*ss)/t;
    *c = *c*static_cast<double>(ae_sign(xxa, _state));
    *s = *s*static_cast<double>(ae_sign(xxa, _state));
}
...
double psi(double x, ae_state *_state)
{
    ...
    if( ae_fp_less_eq(x,10.0)&&ae_fp_eq(x,static_cast<double>(ae_ifloor(x, _state))) )
    {
        y = 0.0;
     ...
     ae_state *_state)
{
    ...
    *bip = 0.0;
    ...
    {
        *ai = static_cast<double>(0);
        *aip = static_cast<double>(0);
        *bi = ae_maxrealnumber;
...
double dawsonintegral(double x, ae_state *_state)
{
    ...
    if( ae_fp_less(x,3.25) )
    {
        ...
        y = x*an/ad;
        result = static_cast<double>(sg)*y;
        return result;
    }
    x2 = 1.0/(x*x);
    if( ae_fp_less(x,6.25) )
    {
        ...
        y = 1.0/x+x2*bn/(bd*x);
        result = static_cast<double>(sg)*0.5*y;
        return result;
    }
    if( ae_fp_greater(x,1.0E9) )
    {
        result = static_cast<double>(sg)*0.5/x;
        return result;
    }
...
double hermitecalculate(ae_int_t n, double x, ae_state *_state)
{
    ...
    for(i=2; i<=n; i++)
    {
        result = static_cast<double>(2)*x*b-static_cast<double>(2*(i-1))*a;
        a = b;
        b = result;
    }
    return result;
     ...
     ae_state *_state)
{
    ...
    for(i=n; i>=0; i--)
    {
        result = static_cast<double>(2)*(x*b1-static_cast<double>(i+1)*b2)+c->ptr.p_double[i];
        b2 = b1;
        b1 = result;
    }
    return result;
     ...
     ae_state *_state)
{
    ...
    c->ptr.p_double[n] = ae_exp(static_cast<double>(n)*ae_log(static_cast<double>(2), _state), _state);
    for(i=0; i<=n/2-1; i++)
    {
        c->ptr.p_double[n-2*(i+1)] = -c->ptr.p_double[n-2*i]*static_cast<double>(n-2*i)*static_cast<double>(n-2*i-1)/static_cast<double>(4)/static_cast<double>(i+1);
    }
}
...
double legendrecalculate(ae_int_t n, double x, ae_state *_state)
{
    ...
    for(i=2; i<=n; i++)
    {
        result = (static_cast<double>(2*i-1)*x*b-static_cast<double>(i-1)*a)/static_cast<double>(i);
        a = b;
        b = result;
    }
    return result;
     ...
     ae_state *_state)
{
    ...
    for(i=n; i>=0; i--)
    {
        result = static_cast<double>(2*i+1)*x*b1/static_cast<double>(i+1)-static_cast<double>(i+1)*b2/static_cast<double>(i+2)+c->ptr.p_double[i];
        b2 = b1;
        b1 = result;
    }
    return result;
     ...
     ae_state *_state)
{
    ...
    for(i=1; i<=n; i++)
    {
        c->ptr.p_double[n] = c->ptr.p_double[n]*static_cast<double>(n+i)/static_cast<double>(2)/static_cast<double>(i);
    }
    for(i=0; i<=n/2-1; i++)
    {
        c->ptr.p_double[n-2*(i+1)] = -c->ptr.p_double[n-2*i]*static_cast<double>(n-2*i)*static_cast<double>(n-2*i-1)/static_cast<double>(2)/static_cast<double>(i+1)/static_cast<double>(2*(n-i)-1);
    }
}
...
double besselj0(double x, ae_state *_state)
{
    ...
    if( ae_fp_greater(x,8.0) )
    {
        ...
        nn = x-ae_pi/static_cast<double>(4);
        result = ae_sqrt(static_cast<double>(2)/ae_pi/x, _state)*(pzero*ae_cos(nn, _state)-qzero*ae_sin(nn, _state));
        return result;
    }
    xsq = ae_sqr(x, _state);
...
double besselj1(double x, ae_state *_state)
{
    ...
    if( ae_fp_greater(x,8.0) )
    {
        ...
        nn = x-static_cast<double>(3)*ae_pi/static_cast<double>(4);
        result = ae_sqrt(static_cast<double>(2)/ae_pi/x, _state)*(pzero*ae_cos(nn, _state)-qzero*ae_sin(nn, _state));
        if( ae_fp_less(s,static_cast<double>(0)) )
        {
            result = -result;
        }
        return result;
...
double besseljn(ae_int_t n, double x, ae_state *_state)
{
    ...
    if( n==0 )
    {
        result = static_cast<double>(sg)*besselj0(x, _state);
        return result;
    }
    if( n==1 )
    {
        result = static_cast<double>(sg)*besselj1(x, _state);
        return result;
    }
    if( n==2 )
    {
        ...
        {
            result = static_cast<double>(sg)*(2.0*besselj1(x, _state)/x-besselj0(x, _state));
        }
        return result;
    }
    ...
    result = static_cast<double>(sg)*ans;
    return result;
}
...
double bessely0(double x, ae_state *_state)
{
    ...
    if( ae_fp_greater(x,8.0) )
    {
        bessel_besselasympt0(x, &pzero, &qzero, _state);
        nn = x-ae_pi/static_cast<double>(4);
        result = ae_sqrt(static_cast<double>(2)/ae_pi/x, _state)*(pzero*ae_sin(nn, _state)+qzero*ae_cos(nn, _state));
        return result;
    }
    xsq = ae_sqr(x, _state);
    ...
    result = p4/q4+static_cast<double>(2)/ae_pi*besselj0(x, _state)*ae_log(x, _state);
    return result;
}
...
double bessely1(double x, ae_state *_state)
{
    ...
    result = x*p4/q4+static_cast<double>(2)/ae_pi*(besselj1(x, _state)*ae_log(x, _state)-static_cast<double>(1)/x);
    return result;
}
...
double besselyn(ae_int_t n, double x, ae_state *_state)
{
    ...
    {
        tmp = b;
        b = static_cast<double>(2*i)/x*b-a;
        a = tmp;
    }
    result = s*b;
    return result;
...
double besselk0(double x, ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater(x,static_cast<double>(0)), "Domain error in BesselK0: x<=0", _state);
    if( ae_fp_less_eq(x,static_cast<double>(2)) )
    {
        y = x*x-2.0;
...
double besselk1(double x, ae_state *_state)
{
    ...
    z = 0.5*x;
    ae_assert(ae_fp_greater(z,static_cast<double>(0)), "Domain error in K1", _state);
    if( ae_fp_less_eq(x,static_cast<double>(2)) )
    {
        y = x*x-2.0;
...
double besselkn(ae_int_t nn, double x, ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater(x,static_cast<double>(0)), "Domain error in BesselKN", _state);
    if( ae_fp_less_eq(x,9.55) )
    {
        ...
        if( n>0 )
        {
            ...
            else
            {
                ...
                for(i=1; i<=n-1; i++)
                {
                    nk1f = nk1f/static_cast<double>(n-i);
                    kf = kf*static_cast<double>(i);
                    zn = zn*z;
                    t = nk1f*zn/kf;
                    s = s+t;
        ...
        {
            pn = pn+1.0/static_cast<double>(n);
            t = 1.0/fn;
        }
        s = (pk+pn-tlg)*t;
        k = 1.0;
        do
        {
            t = t*(z0/(k*(k+static_cast<double>(n))));
            pk = pk+1.0/k;
            pn = pn+1.0/(k+static_cast<double>(n));
            s = s+(pk+pn-tlg)*t;
            k = k+1.0;
        }
     ...
     ae_state *_state)
{
    ...
    *pzero = p2/q2;
    *qzero = static_cast<double>(8)*p3/q3/x;
}
...
double laguerrecalculate(ae_int_t n, double x, ae_state *_state)
{
    ...
    result = static_cast<double>(1);
    a = static_cast<double>(1);
    b = static_cast<double>(1)-x;
    if( n==1 )
    {
        result = b;
    }
    i = static_cast<double>(2);
    while(ae_fp_less_eq(i,static_cast<double>(n)))
    {
        result = ((static_cast<double>(2)*i-static_cast<double>(1)-x)*b-(i-static_cast<double>(1))*a)/i;
        a = b;
        b = result;
        i = i+static_cast<double>(1);
    }
    return result;
}
     ...
     ae_state *_state)
{
    ...
    ae_vector_set_length(c, n+1, _state);
    c->ptr.p_double[0] = static_cast<double>(1);
    for(i=0; i<=n-1; i++)
    {
        c->ptr.p_double[i+1] = -c->ptr.p_double[i]*static_cast<double>(n-i)/static_cast<double>(i+1)/static_cast<double>(i+1);
    }
}
...
double incompleteellipticintegralk(double phi, double m, ae_state *_state)
{
    ...
    if( ae_fp_eq(m,static_cast<double>(0)) )
    {
        result = phi;
        return result;
    }
    a = static_cast<double>(1)-m;
    if( ae_fp_eq(a,static_cast<double>(0)) )
    {
    ...
    if( npio2!=0 )
    {
        k = ellipticintegralk(static_cast<double>(1)-a, _state);
        phi = phi-static_cast<double>(npio2*pio2);
    }
    else
    {
        k = static_cast<double>(0);
    }
    if( ae_fp_less(phi,static_cast<double>(0)) )
    {
        phi = -phi;
        s = -1;
    }
    ...
    b = ae_sqrt(a, _state);
    t = ae_tan(phi, _state);
    if( ae_fp_greater(ae_fabs(t, _state),static_cast<double>(10)) )
    {
        e = 1.0/(b*t);
        if( ae_fp_less(ae_fabs(e, _state),static_cast<double>(10)) )
        {
            e = ae_atan(e, _state);
            if( npio2==0 )
            {
            ...
            result = temp+static_cast<double>(npio2*k);
            return result;
        }
    }
    a = 1.0;
    ...
    {
        temp = b/a;
        phi = phi+ae_atan(t*temp, _state)+static_cast<double>(md*ae_pi);
    ...
    temp = (ae_atan(t, _state)+static_cast<double>(md*ae_pi))/(static_cast<double>(d*a));
    if( s<0 )
    {
        temp = -temp;
    }
...
double ellipticintegrale(double m, ae_state *_state)
{
    ...
    ae_assert(ae_fp_greater_eq(m,static_cast<double>(0))&&ae_fp_less_eq(m,static_cast<double>(1)), "Domain error in EllipticIntegralE: m<0 or m>1", _state);
    m = static_cast<double>(1)-m;
    if( ae_fp_eq(m,static_cast<double>(0)) )
    {
        result = static_cast<double>(1);
        return result;
...
double incompleteellipticintegrale(double phi, double m, ae_state *_state)
{
    ...
    lphi = lphi-static_cast<double>(npio2*pio2);
    if( ae_fp_less(lphi,static_cast<double>(0)) )
    {
        lphi = -lphi;
        s = -1;
    }
    ...
    if( ae_fp_eq(a,static_cast<double>(0)) )
    {
        ...
        result = temp+static_cast<double>(npio2*ebig);
        return result;
    }
    ...
    {
        temp = b/a;
        lphi = lphi+ae_atan(t*temp, _state)+static_cast<double>(md*ae_pi);
    ...
    temp = temp*((ae_atan(t, _state)+static_cast<double>(md*ae_pi))/(static_cast<double>(d*a)));
    temp = temp+e;
    if( s<0 )
    {
        temp = -temp;
